...
task_proto::TeleopGoal ToTaskTeleopGoal(const proto::TeleopCommandRequest& request) {
    task_proto::TeleopGoal goal;
    goal.set_command(static_cast<task_proto::TeleopCommand>(request.command()));
