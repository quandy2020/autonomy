...
ColorRGBA FromProto(const proto::std_msgs::ColorRGBA& proto) { return {proto.r(), proto.g(), proto.b(), proto.a()}; }
...
String FromProto(const proto::std_msgs::String& proto) { return {proto.data()}; }
