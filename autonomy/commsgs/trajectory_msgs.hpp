...
// accelerations]] or positions[, effort] for the trajectory to be executed. All
// specified values are in the same order as the joint names in
// JointTrajectory.msg.
struct JointTrajectoryPoint {
    ...
    // Radians/second^2 for revolute or continuous joints, and meters/second^2
    ...
    // Desired time from the trajectory start to arrive at this trajectory
    // point.
...
struct MultiDOFJointTrajectory {
    // The header is used to specify the coordinate frame and the reference time
    // for the trajectory durations
    ...
    // positions/velocities/accelerations that has the same length as the array
    // of joint names, and has the same order of joints as the joint names
    // array.
