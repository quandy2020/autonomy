...
// 测试构造函数和析构函数
TEST_F(DataRouterTest, Construction) { EXPECT_NE(data_router_, nullptr); }
...
TEST_F(DataRouterTest, ForwardFromRos2) {
  ...
  class TestSensorData : public sensor::Data {
   public:
    ...
    sensor::Time GetTime() const override { return sensor::Time{}; }
    void AddToCostmap(map::common::MapInterface* costmap_builder) override { (void)costmap_builder; }
  };
