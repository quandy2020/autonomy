...
class CameraManager {
 public:
   ...
   */
  CameraBase::SharedPtr CreateDriver(const std::string& driver_class_name, const std::string& driver_name);
   ...
   * @return true 成功，false 失败
   */
  bool RegisterDriver(const std::string& driver_name, CameraBase::SharedPtr driver);
 ...
 private:
   ...
   * @return 驱动实例指针
   */
  CameraBase::SharedPtr CreateDriverFromPlugin(const std::string& library_path, const std::string& driver_class_name);
