...
/** @brief One SRDF `<end_effector>` entry. */
struct SrdfEndEffector {
  std::string name;
  std::string group;
...
/**
 * @brief Parse SRDF `<end_effector>` tags.
 */
bool LoadSrdfEndEffectors(const std::string& path,
 ...
 */
bool LoadSrdfPassiveJoints(const std::string& path,
