...
ErrorCode KinematicsBase::SearchPositionIK(const Pose& tip_pose,
  ...
  for (int a = 1; a < max_attempts; ++a) {
    ...
    core::JointState perturbed = seed;
  ...
  return last == ErrorCode::kSuccess ? ErrorCode::kSuccess
                                     : ErrorCode::kNoIkSolution;
}
