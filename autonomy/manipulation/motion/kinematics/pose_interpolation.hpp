 ...
 */
inline automsgs::msgs::geometry_msgs::Pose InterpolatePose(
    const automsgs::msgs::geometry_msgs::Pose& a,
    const automsgs::msgs::geometry_msgs::Pose& b, double t) {
