...
class ObservationBuffer {
 public:
   ...
   * @param  topic_name The topic of the observations, used as an identifier
   ...
   * considered legal
   * @param  obstacle_max_range The range to which the sensor should be
   * trusted for inserting obstacles
   * @param  obstacle_min_range The range from which the sensor should be
   * trusted for inserting obstacles
   * @param  raytrace_max_range The range to which the sensor should be
