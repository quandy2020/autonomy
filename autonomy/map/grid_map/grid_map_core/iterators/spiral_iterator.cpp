...
const Eigen::Array2i& SpiralIterator::operator*() const { return pointsRing_.back(); }
...
bool SpiralIterator::isPastEnd() const { return (distance_ == nRings_ && pointsRing_.empty()); }
