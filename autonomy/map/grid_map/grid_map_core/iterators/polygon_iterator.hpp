...
#include "autonomy/map/grid_map/grid_map_core/iterators/submap_iterator.hpp"
...
public:
     ...
     */
    PolygonIterator(const grid_map::GridMap& gridMap,
...
private:
    ...
    /*!
     * Finds the submap that fully contains the polygon and returns the
     * parameters.
     ...
     */
    void findSubmapParameters(const grid_map::Polygon& polygon,
