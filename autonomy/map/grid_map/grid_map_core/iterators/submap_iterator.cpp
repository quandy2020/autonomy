...
bool SubmapIterator::operator!=(const SubmapIterator& other) const { return (index_ != other.index_).any(); }

const Index& SubmapIterator::operator*() const { return index_; }

const Index& SubmapIterator::getSubmapIndex() const { return submapIndex_; }
...
bool SubmapIterator::isPastEnd() const { return isPastEnd_; }

const Size& SubmapIterator::getSubmapSize() const { return submapSize_; }
