...
bool LineIterator::operator!=(const LineIterator& other) const { return (index_ != other.index_).any(); }

const Index& LineIterator::operator*() const { return index_; }
...
bool LineIterator::isPastEnd() const { return iCell_ >= nCells_; }
