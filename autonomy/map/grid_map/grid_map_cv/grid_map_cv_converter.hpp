...
public:
     ...
     * @param[in](optional) lowerValue value of the layer corresponding to black
     * image pixels.
     * @param[in](optional) upperValue value of the layer corresponding to white
     * image pixels.
     * @param[in](optional) alphaThreshold the threshold ([0.0, 1.0]) for the
     * alpha value at which cells in the grid map are marked as empty.
     * @return true if successful, false otherwise.
     */
     ...
     * @param[in] lowerValue the value of the layer corresponding to black image
     * pixels.
     * @param[in] upperValue the value of the layer corresponding to white image
     * pixels.
