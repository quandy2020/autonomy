...
public:
     ...
     */
    void configure(std::shared_ptr<autolink::Node> parent, const std::string& name,
                   std::shared_ptr<map::costmap_2d::Costmap2DWrapper>, const proto::MPPIControllerOptions*);
