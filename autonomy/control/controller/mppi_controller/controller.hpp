...
class MPPIController : public common::ControllerInterface {
 ...
 protected:
   ...
   */
  void Visualize(commsgs::planning_msgs::Path transformed_plan, const commsgs::builtin_interfaces::Time& cmd_stamp,
  ...
  std::shared_ptr<autolink::Writer<commsgs::planning_msgs::Path>> opt_traj_pub_;
