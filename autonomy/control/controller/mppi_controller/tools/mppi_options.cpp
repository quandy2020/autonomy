...
proto::MPPIControllerOptions LoadOptions(::autonomy::common::LuaParameterDictionary* const parameter_dictionary) {
  ...
  if (parameter_dictionary->HasKey("goal_checker")) {
    ...
    if (dict) {
      ...
      if (dict->HasKey("xy_goal_tolerance")) {
        goal_checker->set_xy_goal_tolerance(dict->GetDouble("xy_goal_tolerance"));
      }
      if (dict->HasKey("yaw_goal_tolerance")) {
        goal_checker->set_yaw_goal_tolerance(dict->GetDouble("yaw_goal_tolerance"));
      }
      if (dict->HasKey("path_length_tolerance")) {
        goal_checker->set_path_length_tolerance(dict->GetDouble("path_length_tolerance"));
      }
    }
  }
  ...
  if (parameter_dictionary->HasKey("progress_checker")) {
    ...
    if (dict) {
      ...
      if (dict->HasKey("required_movement_radius")) {
        progress_checker->set_required_movement_radius(dict->GetDouble("required_movement_radius"));
      }
      if (dict->HasKey("movement_time_allowance")) {
        progress_checker->set_movement_time_allowance(dict->GetDouble("movement_time_allowance"));
      }
    }
  }
  ...
  if (parameter_dictionary->HasKey("iteration_count")) {
    options.set_iteration_count(parameter_dictionary->GetInt("iteration_count"));
  }
  ...
  if (parameter_dictionary->HasKey("motion_model")) {
    options.set_motion_model(parameter_dictionary->GetString("motion_model"));
  }
  ...
  if (parameter_dictionary->HasKey("TrajectoryVisualizer")) {
    auto tv_dict = parameter_dictionary->GetDictionary("TrajectoryVisualizer");
    if (tv_dict) {
  ...
  if (parameter_dictionary->HasKey("AckermannConstraints")) {
    auto ack_dict = parameter_dictionary->GetDictionary("AckermannConstraints");
    if (ack_dict) {
  ...
  if (parameter_dictionary->HasKey("GoalCritic")) {
    ...
    if (dict) {
      ...
      if (dict->HasKey("threshold_to_consider")) {
        critic->set_threshold_to_consider(dict->GetDouble("threshold_to_consider"));
      }
    }
  }
  ...
  if (parameter_dictionary->HasKey("CostCritic")) {
    ...
    if (dict) {
      ...
      if (dict->HasKey("consider_footprint")) {
        critic->set_consider_footprint(dict->GetBool("consider_footprint"));
      }
      if (dict->HasKey("collision_cost")) {
        critic->set_collision_cost(dict->GetDouble("collision_cost"));
      }
      if (dict->HasKey("near_goal_distance")) {
        critic->set_near_goal_distance(dict->GetDouble("near_goal_distance"));
      }
      if (dict->HasKey("trajectory_point_step")) {
        critic->set_trajectory_point_step(dict->GetInt("trajectory_point_step"));
      }
    }
  }
  ...
  if (parameter_dictionary->HasKey("PathAlignCritic")) {
    ...
    if (dict) {
      ...
      if (dict->HasKey("max_path_occupancy_ratio")) {
        critic->set_max_path_occupancy_ratio(dict->GetDouble("max_path_occupancy_ratio"));
      }
      if (dict->HasKey("trajectory_point_step")) {
        critic->set_trajectory_point_step(dict->GetInt("trajectory_point_step"));
      }
      ...
      if (dict->HasKey("offset_from_furthest")) {
        critic->set_offset_from_furthest(dict->GetInt("offset_from_furthest"));
      }
      if (dict->HasKey("use_path_orientations")) {
        critic->set_use_path_orientations(dict->GetBool("use_path_orientations"));
      }
    }
  }
  ...
  if (parameter_dictionary->HasKey("PathAngleCritic")) {
    ...
    if (dict) {
      ...
      if (dict->HasKey("max_angle_to_furthest")) {
        critic->set_max_angle_to_furthest(dict->GetDouble("max_angle_to_furthest"));
      }
      if (dict->HasKey("forward_preference")) {
        critic->set_forward_preference(dict->GetBool("forward_preference"));
      }
    }
  }
  ...
  if (parameter_dictionary->HasKey("ObstaclesCritic")) {
    ...
    if (dict) {
      ...
      if (dict->HasKey("repulsion_weight")) {
        critic->set_repulsion_weight(dict->GetDouble("repulsion_weight"));
      }
      ...
      if (dict->HasKey("collision_margin_distance")) {
        critic->set_collision_margin_distance(dict->GetDouble("collision_margin_distance"));
      }
      if (dict->HasKey("near_goal_distance")) {
        critic->set_near_goal_distance(dict->GetDouble("near_goal_distance"));
      }
  ...
  if (parameter_dictionary->HasKey("VelocityDeadbandCritic")) {
    auto dict = parameter_dictionary->GetDictionary("VelocityDeadbandCritic");
    if (dict) {
  ...
  if (parameter_dictionary->HasKey("TwirlingCritic")) {
    ...
    if (dict) {
      ...
      if (dict->HasKey("twirling_cost_power")) {
        critic->set_twirling_cost_power(dict->GetInt("twirling_cost_power"));
      }
      if (dict->HasKey("twirling_cost_weight")) {
        critic->set_twirling_cost_weight(dict->GetDouble("twirling_cost_weight"));
      }
    }
  }
