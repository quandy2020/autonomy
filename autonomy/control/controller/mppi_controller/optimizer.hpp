...
class Optimizer {
 public:
   ...
   */
  commsgs::geometry_msgs::TwistStamped evalControl(const commsgs::geometry_msgs::PoseStamped& robot_pose,
 ...
 protected:
   ...
   * @param goal_checker Object to check if goal is completed
   */
  void prepare(const commsgs::geometry_msgs::PoseStamped& robot_pose, const commsgs::geometry_msgs::Twist& robot_speed,
               const commsgs::planning_msgs::Path& plan, const commsgs::geometry_msgs::Pose& goal,
               common::GoalChecker* goal_checker);
   ...
   */
  commsgs::geometry_msgs::TwistStamped getControlFromSequenceAsTwist(const commsgs::builtin_interfaces::Time& stamp);
