...
/**
 * @brief Left-right keypoint homotopy graph
 */
class LRKeyPointGraph : public GraphSearchInterface
{
public:
    AUTONOMY_SHARED_PTR_DEFINITIONS(LRKeyPointGraph);

    LRKeyPointGraph(const TimedElasticBandConfig& cfg, HcController* hcp)
