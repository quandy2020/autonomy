...
/**
 * @brief Circular obstacle defined by center and radius
 */
class CircularObstacle : public Obstacle
{
public:
    AUTONOMY_SHARED_PTR_DEFINITIONS(CircularObstacle);

    CircularObstacle();
    CircularObstacle(const Point& position, double radius);
