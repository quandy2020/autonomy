...
void SetDoubleIfPresent(autonomy::common::LuaParameterDictionary* dict,
...
void SetIntIfPresent(autonomy::common::LuaParameterDictionary* dict,
                     const std::string& key,
...
void SetBoolIfPresent(autonomy::common::LuaParameterDictionary* dict,
                      const std::string& key,
...
void SetStringIfPresent(autonomy::common::LuaParameterDictionary* dict,
                        const std::string& key,
...
proto::TEBControllerOptions LoadOptions(
    ...
    SetStringIfPresent(
        parameter_dictionary, "robot_model",
    ...
    SetDoubleIfPresent(
        parameter_dictionary, "max_global_plan_lookahead_dist",
        [&](double v) { options.set_max_global_plan_lookahead_dist(v); });
    SetDoubleIfPresent(
        parameter_dictionary, "global_plan_prune_distance",
    ...
    SetBoolIfPresent(
        parameter_dictionary, "global_plan_overwrite_orientation",
        [&](bool v) { options.set_global_plan_overwrite_orientation(v); });
    ...
    SetDoubleIfPresent(
        parameter_dictionary, "costmap_obstacles_behind_robot_dist",
        [&](double v) { options.set_costmap_obstacles_behind_robot_dist(v); });
    SetIntIfPresent(parameter_dictionary, "obstacle_poses_affected",
                    [&](int v) { options.set_obstacle_poses_affected(v); });
    SetDoubleIfPresent(
        parameter_dictionary, "costmap_obstacle_sample_resolution",
        [&](double v) { options.set_costmap_obstacle_sample_resolution(v); });
    ...
    SetDoubleIfPresent(
        parameter_dictionary, "weight_kinematics_turning_radius",
        [&](double v) { options.set_weight_kinematics_turning_radius(v); });
    ...
    SetDoubleIfPresent(
        parameter_dictionary, "max_robot_pose_search_dist",
    ...
    SetBoolIfPresent(
        parameter_dictionary, "enable_homotopy_class_planning",
    ...
    SetDoubleIfPresent(
        parameter_dictionary, "oscillation_filter_duration",
        [&](double v) { options.set_oscillation_filter_duration(v); });
    SetStringIfPresent(
        parameter_dictionary, "obstacle_conversion_mode",
        [&](const std::string& v) { options.set_obstacle_conversion_mode(v); });
