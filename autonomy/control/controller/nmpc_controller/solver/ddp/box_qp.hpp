...
/**
 * @file box_qp.hpp
 * @brief Box-constrained QP sub-solver used by control-limited DDP
 */
...
namespace ddp {
/**
 * @class nmpc_controller::ddp::BoxQp
 * @brief Quadratic program with box constraints (control-limited DDP)
 *
 * @tparam VarDim dimension of decision variables
 */
template<int VarDim>
class BoxQp
{
...
public:
   ...
   * @brief Constructor.
   * @param var_dim dimension of decision variables
   * @note dimensions in parameter can be omitted if a fixed value is given in the template value.
   */
