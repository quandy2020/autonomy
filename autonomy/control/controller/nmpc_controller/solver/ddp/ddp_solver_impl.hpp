...
/**
 * @file ddp_solver_impl.hpp
 * @brief Template implementation of nmpc_controller::ddp::DdpSolver
 */
...
#include "autonomy/control/controller/nmpc_controller/solver/ddp/box_qp.hpp"
