...
/**
 * @file ddp_solver.hpp
 * @brief Differential Dynamic Programming solver (nmpc_ddp port)
 */
...
namespace ddp {
/**
 * @class nmpc_controller::ddp::DdpSolver
 * @brief DDP / iLQG solver with optional box input constraints
 *
 * @tparam StateDim state dimension
 * @tparam InputDim input dimension
 *
 * See Tassa et al., IROS 2012 and ICRA 2014.
 */
...
public:
   ...
   * @note The input limits are only considered when with_input_constraint in configuration is true.
   */
...
#include "autonomy/control/controller/nmpc_controller/solver/ddp/ddp_solver_impl.hpp"
