...
/**
 * @brief Topology-Driven MPC controller (T-MPC++), adapted from tud-amr/mpc_planner.
 */
class TdmpcController : public common::ControllerInterface
{
public:
    TdmpcController() = default;
    ~TdmpcController() override = default;
...
private:
    ...
    proto::TdmpcControllerOptions tdmpc_options_;
    ...
    std::unique_ptr<tdmpc::mpc_opt::TdmpcSolver> mpc_solver_;
    tdmpc::tracking::PathSpline path_spline_;
