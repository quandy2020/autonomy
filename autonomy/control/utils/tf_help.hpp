 ...
 * @param extrapolation_fallback If true, if there is an ExtrapolationException,
 * allow looking up the latest timestamp instead.
...
bool transformPose(const TFListenerPtr tf, const std::string frame,
                   ...
                   commsgs::geometry_msgs::PoseStamped& out_pose,
 ...
 */
bool transformPose(const TFListenerPtr tf, const std::string frame,
                   const commsgs::planning_msgs::Pose2DStamped& in_pose,
                   commsgs::planing_msgs::Pose2DStamped& out_pose,
                   const bool extrapolation_fallback = true) {
    commsgs::geometry_msgs::PoseStamped in_3d_pose =
        pose2DToPoseStamped(in_pose);
    commsgs::geometry_msgs::PoseStamped out_3d_pose;

    bool ret = transformPose(tf, frame, in_3d_pose, out_3d_pose,
                             extrapolation_fallback);
    if (ret) {
...
commsgs::geometry_msgs::Pose2D transformStampedPose(
    const TFListenerPtr tf, const commsgs::planning_msgs::Pose2DStamped& pose,
