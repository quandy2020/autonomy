...
public:
     ...
     */
    double applyConstraints(const double v_curr, const double v_cmd, const double accel, const double decel,
                            const double eta);
...
protected:
     ...
     */
    void inputCommandCallback(const std::shared_ptr<commsgs::geometry_msgs::Twist>& msg);
    void inputCommandStampedCallback(const std::shared_ptr<commsgs::geometry_msgs::TwistStamped>& msg);
    ...
    std::shared_ptr<::autolink::Writer<commsgs::geometry_msgs::TwistStamped>> smoothed_cmd_pub_;
    std::shared_ptr<::autolink::Reader<commsgs::geometry_msgs::TwistStamped>> cmd_sub_;
