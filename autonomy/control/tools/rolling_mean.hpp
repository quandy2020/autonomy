...
#ifndef AUTONOMY_CONTROL_TOOLS__ROLLING_MEAN_HPP_
#define AUTONOMY_CONTROL_TOOLS__ROLLING_MEAN_HPP_
 ...
 *
 * Simplified rolling-mean ring buffer (from rcppmath::RollingMeanAccumulator).
 */
template <typename T>
...
public:
  ...
  : buffer_(rolling_window_size, static_cast<T>(0)),
    next_insert_(0),
  ...
  T getRollingMean() const
  {
    ...
    return sum_ / static_cast<T>(valid_data_count);
  }
...
#endif  // AUTONOMY_CONTROL_TOOLS__ROLLING_MEAN_HPP_
