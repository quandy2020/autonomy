...
#include "autonomy/planning/math/smoothing_spline/osqp_spline_1d_solver.hpp"
...
DEFINE_bool(enable_osqp_debug, false, "Enable OSQP debug output");
...
OsqpSpline1dSolver::OsqpSpline1dSolver(const std::vector<double>& x_knots, const uint32_t order)
...
OsqpSpline1dSolver::~OsqpSpline1dSolver() {
    CleanUp();
}
