...
/**
 * @file : spline_2d_seg.cpp
 * @brief: polynomial smoothing spline
 **/

#include "autonomy/planning/math/smoothing_spline/spline_2d_seg.hpp"

namespace autonomy {
namespace planning {
namespace math {

Spline2dSeg::Spline2dSeg(const uint32_t order) : spline_func_x_(order), spline_func_y_(order) {
...
Spline2dSeg::Spline2dSeg(const std::vector<double>& x_param, const std::vector<double>& y_param)
...
bool Spline2dSeg::SetParams(const std::vector<double>& x_param, const std::vector<double>& y_param) {
