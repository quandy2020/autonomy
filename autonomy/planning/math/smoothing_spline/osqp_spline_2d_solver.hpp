...
// #include "gtest/gtest_prod.hpp"  // Only needed for FRIEND_TEST, commented out for now

#include "autonomy/planning/math/smoothing_spline/spline_2d.hpp"
#include "autonomy/planning/math/smoothing_spline/spline_2d_solver.hpp"
#include "osqp/osqp.h"
...
class OsqpSpline2dSolver final : public Spline2dSolver {
 ...
 private:
  // FRIEND_TEST(OSQPSolverTest, basic_test);  // Commented out - gtest_prod.hpp not available
