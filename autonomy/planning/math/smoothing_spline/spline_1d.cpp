...
Spline1d::Spline1d(const std::vector<double>& x_knots, const uint32_t order) : x_knots_(x_knots), spline_order_(order) {
...
const std::vector<Spline1dSeg>& Spline1d::splines() const {
    return splines_;
}
