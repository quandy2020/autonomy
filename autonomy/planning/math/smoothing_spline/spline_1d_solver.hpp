...
#include "autonomy/planning/proto/math/qp_problem.pb.h"

namespace autonomy {
namespace planning {
namespace math {

using autonomy::planning::proto::math::QPMatrix;
using autonomy::planning::proto::math::QuadraticProgrammingProblem;

class Spline1dSolver {
 public:
  Spline1dSolver(const std::vector<double>& x_knots, const uint32_t order)
      : spline_(x_knots, order), constraint_(x_knots, order), kernel_(x_knots, order) {}
