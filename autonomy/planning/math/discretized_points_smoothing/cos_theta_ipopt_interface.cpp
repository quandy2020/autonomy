...
bool CosThetaIpoptInterface::eval_grad_f(int n, const double* x, bool new_x, double* grad_f) {
    ...
    for (size_t i = 0; i < num_of_points_ - 2; ++i) {
        ...
        double q3 =
            ((2 * x[index] - 2 * x[index + 2]) * ((x[index] - x[index + 2]) * (x[index + 2] - x[index + 4]) +
        ...
        for (size_t i = 0; i < num_of_points_ - 2; ++i) {
            ...
            values[idx_map_[std::make_pair(topleft + 3, topleft)]] +=
                ...
                ((q6 * q13) / (2 * q1_sqrt_q1q2) - (q5 * q10) / (2 * q1_sqrt_q1q2) -
                 (q9 * q13) / (2 * sqrt_q1_q2_sqrt_q2) - (3 * q5 * q6 * q4) / (4 * square_q1 * sqrt_q1q2) +
            ...
            values[idx_map_[std::make_pair(topleft + 2, topleft + 1)]] +=
                ...
                ((q5 * q11) / (2 * q1_sqrt_q1q2) - (q6 * q7) / (2 * q1_sqrt_q1q2) -
                 (q8 * q11) / (2 * sqrt_q1_q2_sqrt_q2) - (3 * q5 * q6 * q4) / (4 * square_q1 * sqrt_q1q2) +
            ...
            values[idx_map_[std::make_pair(topleft + 3, topleft + 2)]] +=
                obj_factor * (-weight_cos_included_angle_) *
                ((q6 * q7) / (2 * q1_sqrt_q1q2) - (q9 * q7) / (2 * sqrt_q1_q2_sqrt_q2) +
                 (q5 * q10) / (2 * q1_sqrt_q1q2) - (q8 * q10) / (2 * sqrt_q1_q2_sqrt_q2) +
