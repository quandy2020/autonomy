...
/**
 * @file quartic_polynomial_curve1d.hpp
 **/
...
#include "autonomy/planning/math/curve1d/polynomial_curve1d.hpp"
...
public:
    ...
    QuarticPolynomialCurve1d(const double x0, const double dx0, const double ddx0, const double dx1, const double ddx1,
                             const double param);
     ...
     * @return       self
     */
    QuarticPolynomialCurve1d& FitWithEndPointFirstOrder(const double x0, const double dx0, const double ddx0,
     ...
     */
    QuarticPolynomialCurve1d& FitWithEndPointSecondOrder(const double x0, const double dx0, const double x1,
