...
int main(int argc, char** argv) {
    ...
    // autolink::Init() already calls google::InitGoogleLogging(); do not call
    // it again.
    ...
    if (autonomy::common::FLAGS_configuration_directory.empty() ||
        ...
        AERROR << "Usage: " << argv[0]
               << " --configuration_directory <dir> --configuration_basename "
                  "<file.lua>";
        AERROR << "Example: " << argv[0]
               << " --configuration_directory /path/to/configuration_files"
