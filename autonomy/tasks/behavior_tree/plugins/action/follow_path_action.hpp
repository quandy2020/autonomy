 ...
 */
class FollowPathAction : public BtActionNode<proto::FollowPathAction>
{
...
public:
     ...
     */
    FollowPathAction(const std::string& xml_tag_name, const std::string& action_name,
    ...
    static BT::PortsList providedPorts() {
        return providedBasicPorts({
            BT::InputPort<commsgs::planning_msgs::Path>("path", "Path to follow"),
            BT::InputPort<std::string>("controller_id", ""),
            BT::InputPort<std::string>("goal_checker_id", ""),
            BT::InputPort<std::string>("progress_checker_id", ""),
            BT::OutputPort<int32_t>("error_code_id", "The follow path error code"),
            BT::OutputPort<std::string>("error_msg", "The follow path error msg"),
        });
    }
};
