...
/**
 * @brief A BT::ActionNode that computes a route
 ...
 */
class ComputeRouteAction : public BT::ActionNodeBase
{
public:
    /**
    ...
    static BT::PortsList providedPorts() {
        return {
            BT::InputPort<commsgs::geometry_msgs::PoseStamped>(
                "start", "Start pose for route"),
            BT::InputPort<commsgs::geometry_msgs::PoseStamped>(
                "goal", "Goal pose for route"),
            BT::OutputPort<commsgs::planning_msgs::Path>("route",
                                                         "Computed route"),
        };
    }
