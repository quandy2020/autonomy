...
/**
 * @brief A BT::ActionNode that computes a path through multiple poses
 ...
 */
class ComputePathThroughPosesAction : public BT::ActionNodeBase
{
public:
    /**
     * @brief A constructor for
     * autonomy::tasks::behavior_tree::plugins::action::ComputePathThroughPosesAction
    ...
    static BT::PortsList providedPorts() {
        return {
            BT::InputPort<commsgs::planning_msgs::Goals>(
                "goals", "Array of poses to compute path through"),
            BT::OutputPort<commsgs::planning_msgs::Path>(
                "path", "Computed path through poses"),
        };
    }
