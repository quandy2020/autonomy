 ...
 */
class SpinAction : public BtActionNode<proto::SpinAction>
{
    using Action = proto::SpinAction;
...
public:
     ...
     */
    SpinAction(const std::string& xml_tag_name, const std::string& action_name,
