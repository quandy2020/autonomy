...
private:
     ...
     */
    void callbackGoalCheckerSelect(std::shared_ptr<const commsgs::std_msgs::String> msg);

    std::shared_ptr<autolink::Reader<commsgs::std_msgs::String>> goal_checker_selector_sub_;
