 ...
 */
class ControllerCancel : public BtCancelActionNode<proto::FollowPathAction> {
 public:
  /**
   ...
   */
  ControllerCancel(const std::string& xml_tag_name, const std::string& action_name, const BT::NodeConfiguration& conf);
