...
{
public:
    GloballyUpdatedGoalCondition(const std::string& name, const BT::NodeConfiguration& conf)
...
REGISTER_BEHAVIOR_TREE_NODE(GloballyUpdatedGoalCondition, "GlobalUpdatedGoal")
