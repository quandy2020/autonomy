 ...
 * stores the index of the last running child in the blackboard (key:
 * "current_child_idx"), and it does not reset the index when it got halted. It
 * used to tick children in an ordered sequence. If any child returns RUNNING,
 * previous children will NOT be ticked again.
 *
