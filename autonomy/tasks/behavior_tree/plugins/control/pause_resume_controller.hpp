...
of the tree
 * It has one mandatory child for the RESUMED, and three optional for the
 PAUSED state,
 ...
 *
 * The controller starts in RESUMED state, and ticks it until it returns
 success.
 ...
 *
 * The controller only returns success when the RESUMED child returns
 success.
