...
#include "autonomy/tasks/behavior_tree/control/pipeline_sequence.hpp"
...
{
  factory.registerNodeType<autonomy::tasks::behavior_tree::control::PipelineSequence>("PipelineSequence");
}