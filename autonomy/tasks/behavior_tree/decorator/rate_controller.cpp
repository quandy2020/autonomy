...
#include "autonomy/tasks/behavior_tree/decorator/rate_controller.hpp"
...
{
    factory.registerNodeType<autonomy::tasks::behavior_tree::decorator::RateController>("RateController");
}