 ...
 */
template<>
inline commsgs::geometry_msgs::Point convertFromString(const StringView key)
{
 ...
 */
template<>
inline commsgs::geometry_msgs::Quaternion convertFromString(const StringView key)
{
 ...
 */
template<>
inline commsgs::geometry_msgs::PoseStamped convertFromString(const StringView key)
{
    ...
    if (parts.size() != 9) {
        ...
        // pose_stamped.header.stamp = commsgs::builtin_interfaces::Time(BT::convertFromString<int64_t>(parts[0]));
 ...
 */
template<>
inline std::vector<commsgs::geometry_msgs::PoseStamped> convertFromString(const StringView key)
{
 ...
 */
template<>
inline commsgs::planning_msgs::Path convertFromString(const StringView key)
{
    // 9 real numbers separated by semicolons
    auto parts = BT::splitString(key, ';');
    if ((parts.size() - 2) % 9 != 0) {
