...
class BtActionNode : public BT::ActionNodeBase {
  ...
  BT::NodeStatus tick() override {
    ...
    try {
      ...
      if (future_goal_handle_) {
        ...
        auto elapsed = std::chrono::duration_cast<std::chrono::milliseconds>(std::chrono::nanoseconds(elapsed_ns));
 ...
 protected:
  ...
  std::shared_ptr<std::shared_future<std::shared_ptr<autolink::action::ClientGoalHandle<ActionT>>>> future_goal_handle_;
