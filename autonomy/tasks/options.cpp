...
proto::TaskNavigatorOptions LoadTaskNavigatorOptions(
    ::autonomy::common::LuaParameterDictionary* const parameter_dictionary) {
    proto::TaskNavigatorOptions options;
...
proto::TaskOptions LoadOptions(
    ...
    if (parameter_dictionary->HasKey("tasks")) {
        auto navigator_dict = parameter_dictionary->GetDictionary("tasks");
        *options.mutable_navigator_options() =
            LoadTaskNavigatorOptions(navigator_dict.get());
    }
