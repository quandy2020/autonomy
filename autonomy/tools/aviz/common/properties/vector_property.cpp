...
VectorProperty::VectorProperty(const QString& name, const Ogre::Vector3& default_value, const QString& description,
...
Ogre::Vector3 VectorProperty::getVector() const { return vector_; }

bool VectorProperty::add(const Ogre::Vector3& offset) { return setVector(getVector() + offset); }
...
void VectorProperty::updateString() {
  value_ = QString("%1; %2; %3").arg(vector_.x, 0, 'g', 5).arg(vector_.y, 0, 'g', 5).arg(vector_.z, 0, 'g', 5);
}
