...
EnumProperty::EnumProperty(const QString& name, const QString& default_value,
...
QWidget* EnumProperty::createEditor(QWidget* parent,
    ...
    Q_UNUSED(option);
    // Emit requestOptions() to give listeners a chance to change the option
    // list.
    ...
    QObject::connect(
        cb, QOverload<const QString&>::of(&QComboBox::currentTextChanged), this,
