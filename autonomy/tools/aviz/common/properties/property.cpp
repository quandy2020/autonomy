...
Property::Property(const QString& name, const QVariant default_value, const QString& description, Property* parent,
...
QVariant Property::getValue() const { return value_; }
...
QString Property::getName() const { return objectName(); }

std::string Property::getNameStd() const { return getName().toStdString(); }

void Property::setIcon(const QIcon& icon) { icon_ = icon; }

QIcon Property::getIcon() const { return icon_; }

void Property::setDescription(const QString& description) { description_ = description; }

QString Property::getDescription() const { return description_; }
...
int Property::numChildren() const { return children_.size(); }
...
Property* Property::childAtUnchecked(int index) const { return children_.at(index); }
...
Property* Property::getParent() const { return parent_; }

void Property::setParent(Property* new_parent) { parent_ = new_parent; }
...
bool Property::paint(QPainter* painter, const QStyleOptionViewItem& option) const {
  (void)painter;
  (void)option;
  return false;
}
...
PropertyTreeModel* Property::getModel() const { return model_; }
...
bool Property::shouldBeSaved() const { return !is_read_only_ && save_; }

void Property::setShouldBeSaved(bool save) { save_ = save; }
...
QWidget* Property::createEditor(QWidget* parent, const QStyleOptionViewItem& option) {
  ...
  switch (static_cast<int>(value_.type())) {
    ...
    case QMetaType::Float:
    case QVariant::Double: {
      // For now, use QLineEdit for float (can be extended with FloatEdit later)
...
void Property::hide() { setHidden(true); }

void Property::show() { setHidden(false); }
...
bool Property::getHidden() const { return hidden_; }

void Property::setReadOnly(bool read_only) { is_read_only_ = read_only; }

bool Property::getReadOnly() { return is_read_only_; }

bool Property::isExpanded() { return is_expanded_; }
