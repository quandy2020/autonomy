...
QColor ogreToQt(const Ogre::ColourValue& c) { return QColor::fromRgbF(c.r, c.g, c.b, c.a); }

Ogre::ColourValue qtToOgre(const QColor& c) { return Ogre::ColourValue(c.redF(), c.greenF(), c.blueF(), c.alphaF()); }
