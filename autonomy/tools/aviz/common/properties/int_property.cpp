...
IntProperty::IntProperty(const QString& name, int default_value, const QString& description, Property* parent,
                         const char* changed_slot, QObject* receiver, int min_value, int max_value)
