...
public:
     ...
     */
    virtual bool transform(const std::string& source_frame, const std::string& target_frame, double x, double y,
                           double z, double qx, double qy, double qz, double qw, double& out_x, double& out_y,
                           double& out_z, double& out_qx, double& out_qy, double& out_qz, double& out_qw,
                           uint64_t time = 0) = 0;
