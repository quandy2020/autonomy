...
void FrameManager::setPause(bool pause) { pause_ = pause; }

bool FrameManager::getPause() { return pause_; }

void FrameManager::setSyncMode(SyncMode mode) { sync_mode_ = mode; }

FrameManagerIface::SyncMode FrameManager::getSyncMode() { return sync_mode_; }

void FrameManager::syncTime(uint64_t time_ns) { current_time_ = time_ns; }

uint64_t FrameManager::getTime() { return current_time_; }
...
const std::string& FrameManager::getFixedFrame() { return fixed_frame_; }
...
std::shared_ptr<transformation::FrameTransformer> FrameManager::getTransformer() { return nullptr; }
