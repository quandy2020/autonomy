...
/// Pure-virtual base class for objects which give Display subclasses context in
/// which to work.
/**
...
public:
    ...
    virtual std::shared_ptr<aviz::common::interaction::SelectionManagerIface>
    getSelectionManager() const = 0;

    /// Return a pointer to the HandlerManager.
    virtual std::shared_ptr<aviz::common::interaction::HandlerManagerIface>
    getHandlerManager() const = 0;

    /// Return a pointer to the ViewPicker.
    virtual std::shared_ptr<aviz::common::interaction::ViewPickerIface>
    ...
    /// Return a factory for creating Display subclasses based on a class id
    /// string.
    ...
    virtual transformation::TransformationManager*
