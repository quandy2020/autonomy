...
/**
 * This function creates a shared_ptr for any SelectionHandler, registering a
 * handle with the HandlerManager.
 */
...
private:
    ...
    aviz::common::interaction::createSelectionHandler(Args... arguments);
};
