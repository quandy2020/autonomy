...
UniformStringStream::UniformStringStream() { imbue(std::locale("C")); }

UniformStringStream::UniformStringStream(const std::string& str) : std::stringstream(str) { imbue(std::locale("C")); }
