...
ViewController::ViewController()
    : Property("View", QVariant(), "", nullptr), context_(nullptr), is_active_(false), class_id_("") {
...
void ViewController::handleMouseEvent(ViewportMouseEvent& evt) { (void)evt; }
...
void ViewController::lookAt(float x, float y, float z) { lookAt(QVector3D(x, y, z)); }
...
QString ViewController::getClassId() const { return class_id_; }

void ViewController::setClassId(const QString& class_id) { class_id_ = class_id; }
...
bool ViewController::isActive() const { return is_active_; }

QCursor ViewController::getCursor() { return cursor_; }

FocalPointStatus ViewController::getFocalPointStatus() { return FocalPointStatus(false, QVector3D(0, 0, 0)); }
...
void ViewController::setCursor(QCursor cursor) { cursor_ = cursor; }
