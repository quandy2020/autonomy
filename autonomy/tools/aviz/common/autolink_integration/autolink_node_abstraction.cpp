...
AutolinkNodeAbstraction::AutolinkNodeAbstraction(const std::string& node_name) : node_name_(node_name) {
...
std::string AutolinkNodeAbstraction::get_node_name() const { return node_name_; }

std::map<std::string, std::vector<std::string>> AutolinkNodeAbstraction::get_channel_names_and_types() const {
...
std::shared_ptr<::autolink::Node> AutolinkNodeAbstraction::get_raw_node() { return raw_node_; }
