...
{
public:
    static void createColorMaterial(const std::string& name,
    ...
    static Ogre::MaterialPtr createMaterialWithShadowsAndLighting(
        std::string name);

    static Ogre::MaterialPtr createMaterialWithShadowsAndNoLighting(
        std::string name);
    ...
    static void enableAlphaBlending(Ogre::SceneBlendType& blending,
