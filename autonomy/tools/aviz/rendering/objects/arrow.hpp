...
public:
     ...
     * @param parent_node A scene node to use as the parent of this object. If
     * NULL, uses the root scene node.
    ...
    Arrow(Ogre::SceneManager* scene_manager,
          Ogre::SceneNode* parent_node = nullptr, float shaft_length = 1.0f,
    ...
    /**
     * @brief Set the color of this arrow. Sets both the head and shaft color to
     * the same value.
     */
    ...
    /** @brief Set the orientation. Note that negative Z is the identity
     * orientation. */
