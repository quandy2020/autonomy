...
public:
     ...
     * @param scene_manager The Ogre scene manager this object is associated
     * with
     * @param parent_node A scene node to use as the parent of this object. If
     * NULL, uses the root scene node.
     */
    AVIZ_RENDERING_PUBLIC
    Shape(Type shape_type, Ogre::SceneManager* scene_manager,
     ...
     * @param offset Amount to offset the center of the object from the pivot
     * point
     */
    AVIZ_RENDERING_PUBLIC
