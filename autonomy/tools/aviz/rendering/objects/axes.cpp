...
Axes::Axes(Ogre::SceneManager* scene_manager, Ogre::SceneNode* parent_node,
    ...
    x_axis_ =
        std::make_unique<Shape>(Shape::Cylinder, scene_manager_, scene_node_);
    y_axis_ =
        std::make_unique<Shape>(Shape::Cylinder, scene_manager_, scene_node_);
    z_axis_ =
        std::make_unique<Shape>(Shape::Cylinder, scene_manager_, scene_node_);
