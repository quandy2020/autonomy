...
Axes::~Axes() { scene_manager_->destroySceneNode(scene_node_); }
...
void Axes::setPosition(const Ogre::Vector3& position) { scene_node_->setPosition(position); }

void Axes::setOrientation(const Ogre::Quaternion& orientation) { scene_node_->setOrientation(orientation); }

void Axes::setScale(const Ogre::Vector3& scale) { scene_node_->setScale(scale); }
...
const Ogre::Vector3& Axes::getPosition() { return scene_node_->getPosition(); }

const Ogre::Quaternion& Axes::getOrientation() { return scene_node_->getOrientation(); }
...
void Axes::setXColor(const Ogre::ColourValue& col) { x_axis_->setColor(col.r, col.g, col.b, col.a); }

void Axes::setYColor(const Ogre::ColourValue& col) { y_axis_->setColor(col.r, col.g, col.b, col.a); }

void Axes::setZColor(const Ogre::ColourValue& col) { z_axis_->setColor(col.r, col.g, col.b, col.a); }
...
const Ogre::ColourValue& Axes::getDefaultXColor() { return default_x_color_; }

const Ogre::ColourValue& Axes::getDefaultYColor() { return default_y_color_; }

const Ogre::ColourValue& Axes::getDefaultZColor() { return default_z_color_; }
