 ...
 *
 * Displays a multi-segment line strip rendered as billboards (always facing
 * camera)
 */
...
public:
    ...
    explicit BillboardLine(Ogre::SceneManager* scene_manager,
...
private:
    ...
    void changeAllElements(std::function<Ogre::BillboardChain::Element(
