...
void RegisterDefaultPlugins() {
    ...
    // Register RobotModelDisplay (top-level class, not in namespace)
    {
        ...
        desc.description =
            "Displays a visual representation of a robot from URDF files.";
        ...
        factory.registerPlugin(
            ...
            [](const std::string& name)
                -> std::unique_ptr<aviz::common::Display> {
    ...
    // Register AccelDisplay
    {
        ...
        desc.base_class = "Display";
        desc.message_types.clear();
        factory.registerPlugin(desc,
                               [](const std::string& name)
                                   -> std::unique_ptr<aviz::common::Display> {
                                   return std::make_unique<AccelDisplay>(
    ...
    // Register CameraDisplay
    {
        ...
        factory.registerPlugin(desc,
                               [](const std::string& name)
                                   -> std::unique_ptr<aviz::common::Display> {
                                   return std::make_unique<CameraDisplay>(
                                       QString::fromStdString(name));
                               });
    }
    ...
    // Register DepthCloudDisplay
    {
        ...
        factory.registerPlugin(desc,
                               [](const std::string& name)
                                   -> std::unique_ptr<aviz::common::Display> {
                                   return std::make_unique<DepthCloudDisplay>(
                                       QString::fromStdString(name));
                               });
    }
    ...
    // Register EffortDisplay
    {
        ...
        factory.registerPlugin(desc,
                               [](const std::string& name)
                                   -> std::unique_ptr<aviz::common::Display> {
                                   return std::make_unique<EffortDisplay>(
                                       QString::fromStdString(name));
                               });
    }
    ...
    // Register FluidPressureDisplay
    {
        ...
        factory.registerPlugin(
            ...
            [](const std::string& name)
                -> std::unique_ptr<aviz::common::Display> {
                return std::make_unique<FluidPressureDisplay>(
                    QString::fromStdString(name));
            });
    }
    ...
    // Register GridCellsDisplay
    {
        ...
        factory.registerPlugin(desc,
                               [](const std::string& name)
                                   -> std::unique_ptr<aviz::common::Display> {
                                   return std::make_unique<GridCellsDisplay>(
                                       QString::fromStdString(name));
                               });
    }
    ...
    // Register IlluminanceDisplay
    {
        ...
        factory.registerPlugin(desc,
                               [](const std::string& name)
                                   -> std::unique_ptr<aviz::common::Display> {
                                   return std::make_unique<IlluminanceDisplay>(
                                       QString::fromStdString(name));
                               });
    }
    ...
    // Register ImageDisplay
    {
        ...
        factory.registerPlugin(desc,
                               [](const std::string& name)
                                   -> std::unique_ptr<aviz::common::Display> {
                                   return std::make_unique<ImageDisplay>(
                                       QString::fromStdString(name));
                               });
    }
        ...
        factory.registerPlugin(
            ...
            [](const std::string& name)
                ...
                return std::make_unique<
                    aviz::plugins::displays::InteractiveMarkersDisplay>(
                    QString::fromStdString(name));
            });
    }
    ...
    // Register LaserScanDisplay
    {
        ...
        factory.registerPlugin(desc,
                               [](const std::string& name)
                                   -> std::unique_ptr<aviz::common::Display> {
                                   return std::make_unique<LaserScanDisplay>(
                                       QString::fromStdString(name));
                               });
    }
    ...
    // Register MapDisplay
    {
        ...
        factory.registerPlugin(desc,
                               [](const std::string& name)
                                   -> std::unique_ptr<aviz::common::Display> {
                                   return std::make_unique<MapDisplay>(
                                       QString::fromStdString(name));
                               });
    }
    ...
    // Register MarkerDisplay
    {
        ...
        factory.registerPlugin(desc,
                               [](const std::string& name)
                                   -> std::unique_ptr<aviz::common::Display> {
                                   return std::make_unique<MarkerDisplay>(
                                       QString::fromStdString(name));
                               });
    }
    ...
    // Register MarkerArrayDisplay
    {
        ...
        factory.registerPlugin(desc,
                               [](const std::string& name)
                                   -> std::unique_ptr<aviz::common::Display> {
                                   return std::make_unique<MarkerArrayDisplay>(
                                       QString::fromStdString(name));
                               });
    }
    ...
    // Register PointDisplay
    {
        ...
        factory.registerPlugin(desc,
                               [](const std::string& name)
                                   -> std::unique_ptr<aviz::common::Display> {
                                   return std::make_unique<PointDisplay>(
                                       QString::fromStdString(name));
                               });
    }
    ...
    // Register PolygonDisplay
    {
        ...
        factory.registerPlugin(desc,
                               [](const std::string& name)
                                   -> std::unique_ptr<aviz::common::Display> {
                                   return std::make_unique<PolygonDisplay>(
                                       QString::fromStdString(name));
                               });
    }
    ...
    // Register PoseArrayDisplay
    {
        ...
        factory.registerPlugin(desc,
                               [](const std::string& name)
                                   -> std::unique_ptr<aviz::common::Display> {
                                   return std::make_unique<PoseArrayDisplay>(
                                       QString::fromStdString(name));
                               });
    }
    ...
    // Register PoseWithCovarianceDisplay
    {
        ...
        factory.registerPlugin(
            ...
            [](const std::string& name)
                -> std::unique_ptr<aviz::common::Display> {
                return std::make_unique<
                    aviz::plugins::displays::PoseCovarianceDisplay>(
                    QString::fromStdString(name));
            });
    }
    ...
    // Register RangeDisplay
    {
        ...
        factory.registerPlugin(desc,
                               [](const std::string& name)
                                   -> std::unique_ptr<aviz::common::Display> {
                                   return std::make_unique<RangeDisplay>(
                                       QString::fromStdString(name));
                               });
    }
    ...
    // Register RelativeHumidityDisplay
    {
        ...
        factory.registerPlugin(
            ...
            [](const std::string& name)
                -> std::unique_ptr<aviz::common::Display> {
                return std::make_unique<RelativeHumidityDisplay>(
                    QString::fromStdString(name));
            });
    }

    // Note: RobotModelDisplay from displays/robot_model/robot_model_display.hpp
    // is in aviz::plugins::displays namespace, but we already registered the
    // top-level one above.
    ...
    // Register ScrewDisplay
    {
        ...
        factory.registerPlugin(desc,
                               [](const std::string& name)
                                   -> std::unique_ptr<aviz::common::Display> {
                                   return std::make_unique<ScrewDisplay>(
                                       QString::fromStdString(name));
                               });
    }
    ...
    // Register TemperatureDisplay
    {
        ...
        factory.registerPlugin(desc,
                               [](const std::string& name)
                                   -> std::unique_ptr<aviz::common::Display> {
                                   return std::make_unique<TemperatureDisplay>(
                                       QString::fromStdString(name));
                               });
    }
    ...
    // Register TFDisplay
    {
        ...
        factory.registerPlugin(
            ...
            [](const std::string& name)
                -> std::unique_ptr<aviz::common::Display> {
                return std::make_unique<aviz::plugins::displays::TfDisplay>(
                    QString::fromStdString(name));
            });
    }
    ...
    // Register TwistDisplay
    {
        ...
        factory.registerPlugin(desc,
                               [](const std::string& name)
                                   -> std::unique_ptr<aviz::common::Display> {
                                   return std::make_unique<TwistDisplay>(
                                       QString::fromStdString(name));
                               });
    }
    ...
    // Register WrenchDisplay
    {
        ...
        factory.registerPlugin(desc,
                               [](const std::string& name)
                                   -> std::unique_ptr<aviz::common::Display> {
                                   return std::make_unique<WrenchDisplay>(
                                       QString::fromStdString(name));
                               });
    }
}
