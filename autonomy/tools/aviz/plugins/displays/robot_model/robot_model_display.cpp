...
RobotModelDisplay::RobotModelDisplay(const QString& name) : aviz::common::Display(), robot_loaded_(false) {
  ...
  robot_description_property_ = new aviz::common::properties::StringProperty(
      QString("Robot Description"), QString(""), QString("URDF robot description (XML string or file path)."), nullptr,
...
void RobotModelDisplay::onInitialize() { aviz::common::Display::onInitialize(); }
...
void RobotModelDisplay::onDisable() { aviz::common::Display::onDisable(); }
