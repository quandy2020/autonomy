...
void PointDisplay::setUpProperties() {
    color_property_ =
        new aviz::common::properties::ColorProperty(QString("Color"), QColor(204, 41, 204), QString("Color of a point"),
                                                    nullptr, SLOT(updateColorAndAlpha()), this);

    alpha_property_ = new aviz::common::properties::FloatProperty(
        QString("Alpha"), 1.0f, QString("0 is fully transparent, 1.0 is fully opaque."), nullptr,
        SLOT(updateColorAndAlpha()), this);

    radius_property_ = new aviz::common::properties::FloatProperty(
        QString("Radius"), 0.2f, QString("Radius of a point"), nullptr, SLOT(updateColorAndAlpha()), this);
