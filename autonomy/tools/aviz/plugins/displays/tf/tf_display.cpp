...
TfDisplay::TfDisplay(const QString& name) : aviz::common::Display(), last_update_time_(0.0f) {
  ...
  axes_length_property_ = new aviz::common::properties::FloatProperty(
      QString("Axes Length"), 0.1f, QString("Length of each axis, in meters."), nullptr, SLOT(updateShowAxes()), this);
  axes_length_property_->setMin(0.01f);

  axes_radius_property_ = new aviz::common::properties::FloatProperty(
      QString("Axes Radius"), 0.01f, QString("Radius of each axis, in meters."), nullptr, SLOT(updateShowAxes()), this);
...
void TfDisplay::onInitialize() { aviz::common::Display::onInitialize(); }
