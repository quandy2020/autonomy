 ...
 */
class PathDisplay
    : public AutolinkTopicDisplay<autonomy::commsgs::planning_msgs::Path>
{
    Q_OBJECT
...
private:
    void destroyObjects();
    void allocateArrowVector(std::vector<aviz::rendering::Arrow*>& arrow_vect,
                             size_t num);
    void allocateAxesVector(std::vector<aviz::rendering::Axes*>& axes_vect,
                            size_t num);
    void destroyPoseAxesChain();
    void destroyPoseArrowChain();
    void updateManualObject(Ogre::ManualObject* manual_object,
    ...
    aviz::common::properties::FloatProperty*
