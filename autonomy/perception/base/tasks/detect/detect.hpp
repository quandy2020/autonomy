...
#ifndef AUTONOMY_PERCEPTION_BASE_TASKS_DETECT_DETECT_HPP_
#define AUTONOMY_PERCEPTION_BASE_TASKS_DETECT_DETECT_HPP_
...
/** @brief Decode YOLO26 detect. Contract: output0 [1,max_det,6]. */
...
#endif  // AUTONOMY_PERCEPTION_BASE_TASKS_DETECT_DETECT_HPP_
