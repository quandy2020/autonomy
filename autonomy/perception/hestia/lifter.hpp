...
#ifndef AUTONOMY_PERCEPTION_HESTIA_LIFTER_HPP_
#define AUTONOMY_PERCEPTION_HESTIA_LIFTER_HPP_
...
/**
 * @brief Lifts 2D detections into camera- or base-frame 3D AABBs.
 */
class DepthLifter
{
public:
    ...
    /**
     * @brief Lifts every 2D detection that passes the depth gate.
     *
...
#endif  // AUTONOMY_PERCEPTION_HESTIA_LIFTER_HPP_
