...
#include "autonomy/common/eventpp/mixins/mixinheterfilter.hpp"
...
class HeterEventDispatcherBase {
 ...
 public:
  HeterEventDispatcherBase() : eventCallbackListMap(), listenerMutex() {}
...
class HeterEventDispatcher
 ...
 public:
  ...
  friend void swap(HeterEventDispatcher& first, HeterEventDispatcher& second) noexcept { first.swap(second); }
};
