...
#include "autonomy/common/state_estimation/kalman_filter/kalman_filter.hpp"
...
#include "autonomy/common/state_estimation/measurement/linear_measurement.hpp"
...
using autonomy::common::motion_model::LinearMotionModel;
using autonomy::common::motion_model::StationaryMotionModel;
using autonomy::common::state_estimation::KalmanFilter;
using autonomy::common::state_estimation::LinearMeasurement;
using autonomy::common::state_estimation::make_correction_only_kalman_filter;
using autonomy::common::state_estimation::make_kalman_filter;
using autonomy::common::state_estimation::NoiseInterface;
using autonomy::common::state_estimation::WienerNoise;
...
using autonomy::common::state_vector::Variable;
...
// /// @test Test that a filter can be created and reset and is in a valid state
// throughout this. TEST(TestKalmanFilter, CreateAndReset) {
...
//     motion_model, noise_model, State{},
...
// /// @test Test that predictions without measurements always increase
// uncertainty.
...
/// @test Test that we can track a static object measuring only its partial
/// state.
...
///
/// @details The object is assumed to move at a straight line, changing its
/// orientation with
///     constant angular velocity. All the variables, X, Y, YAW are changing
///     independently.
...
/// \test Track a ball thrown at 45 deg angle. We perfectly observe positions of
/// the ball.
///
...
/// \test Check that Kalman Filter can be used for classification. In this
/// example of a traffic light state.
