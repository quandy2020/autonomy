...
public:
    ...
    /**
     * @brief Prints the relevant information (name, rows, values) of this
     * component.
...
public:
    ...
    /**
     * @brief  Creates a Composite holding either variables, costs or
     * constraints.
     * @param  is_cost  True if this class holds cost terms, false for all
     * others.
     *
...
private:
    ...
    bool is_cost_;
    // The number of variables for costs/constraint composites (not set for
    // variables). Is initialized the first the GetJacobian() is called.
