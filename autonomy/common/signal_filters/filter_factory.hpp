...
#ifndef AUTONOMY_COMMON_SIGNAL_FILTERS_FILTER_FACTORY_HPP_
#define AUTONOMY_COMMON_SIGNAL_FILTERS_FILTER_FACTORY_HPP_
...
#include "autonomy/common/signal_filters/low_pass_filter.hpp"
...
class SIGNAL_FILTERS_PUBLIC
FilterFactory{public :
                  ...
                  static std::unique_ptr<FilterBase<T, ClockT>>
                      create(const std::string& type, T cutoff_frequency){
...
///                             around here
/// \tparam T The floating point type of the filter
/// \tparam ClockT The clock type of the filter. Use default parameter if you
/// want to provide
///                durations between points yourself
template <typename T, typename ClockT = DummyClock>
static std::unique_ptr<FilterBase<T, ClockT>> create(FilterType type,
                                                     T cutoff_frequency) {
    switch (type) {
...
#endif  // AUTONOMY_COMMON_SIGNAL_FILTERS_FILTER_FACTORY_HPP_
