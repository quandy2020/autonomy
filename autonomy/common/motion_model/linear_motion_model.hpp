...
#ifndef AUTONOMY_COMMON_MOTION_MODEL_LINEAR_MOTION_MODEL_HPP_
#define AUTONOMY_COMMON_MOTION_MODEL_LINEAR_MOTION_MODEL_HPP_
...
///
/// @details    This class is designed to handle all the linear motion models,
/// i.e., those that only
///             have independent variables in them. In this case, the Jacobian
///             is just a transition matrix.
///
...
#endif  // AUTONOMY_COMMON_MOTION_MODEL_LINEAR_MOTION_MODEL_HPP_
