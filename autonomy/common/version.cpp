...
const std::string GIT_COMMIT_DATE =
    ...
    "2026-02-12 16:37:09"
    "";
const std::string GIT_VERSION = "v0.1.1-40-g9a7bd35-dirty";
const std::string GIT_BRANCH = "master";

// 构建信息
const std::string BUILD_TIMESTAMP = "2026-02-12 08:47:52";
const std::string BUILD_HOST = "71e9b5bcd8d4";
...
#endif
    return absl::StrCat("Autonomy develop info: Commit ", AUTONOMY_COMMIT_ID, " on ", AUTONOMY_COMMIT_DATE, " ",
                        cuda_info);
}
