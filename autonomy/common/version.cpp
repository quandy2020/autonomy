...
const std::string GIT_COMMIT_DATE = """2026-06-30 21:41:00""";
const std::string GIT_VERSION = "424e09e4-dirty";
const std::string GIT_BRANCH = "feature/library";

// 构建信息
const std::string BUILD_TIMESTAMP = "2026-06-30 15:08:07";
...
const std::string SYSTEM_VERSION = "6.17.0-1025-oem";
