...
#ifndef AUTONOMY_COMMON_LUA_PARAMETER_DICTIONARY_HPP_
#define AUTONOMY_COMMON_LUA_PARAMETER_DICTIONARY_HPP_
...
#include "autonomy/common/lua.hpp"
...
private:
    ...
    // Pop the top of the stack and CHECKs that it is a string. The returned
    // value is either quoted to be suitable to be read back by a Lua
    // interpretor or not.
...
#endif  // AUTONOMY_COMMON_LUA_PARAMETER_DICTIONARY_HPP_
