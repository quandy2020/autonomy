...
#ifndef AUTONOMY_COMMON_MATH_AABOXKDTREE2D_HPP_
#define AUTONOMY_COMMON_MATH_AABOXKDTREE2D_HPP_
...
#include "autonomy/common/math/aabox2d.hpp"
#include "autonomy/common/math/math_utils.hpp"
#include "glog/logging.h"

/**
 * @namespace autonomy::common::math
...
class AABoxKDTree2dNode {
 ...
 private:
  ...
  void GetObjectsInternal(const Vec2d& point, const double distance, const double distance_sqr,
  ...
  void GetNearestObjectInternal(const Vec2d& point, double* const min_distance_sqr,
  ...
  void PartitionObjects(const std::vector<ObjectPtr>& objects, std::vector<ObjectPtr>* const left_subnode_objects,
...
#endif  // AUTONOMY_COMMON_MATH_AABOXKDTREE2D_HPP_