...
#include "autonomy/common/math/aaboxkdtree2d.hpp"
...
class Object {
 public:
  ...
  double DistanceTo(const Vec2d& point) const { return line_segment_.DistanceTo(point); }
  double DistanceSquareTo(const Vec2d& point) const { return line_segment_.DistanceSquareTo(point); }
