...
#ifndef AUTONOMY_COMMON_SIGNAL_PROCESSING_BUTTERWORTH_HPP_
#define AUTONOMY_COMMON_SIGNAL_PROCESSING_BUTTERWORTH_HPP_
...
class ButterworthFilter {
 ...
 private:
   ...
   * the polar coordinate system . The algorithm first locates the poles
   * computing the phase angle and then poles as a complex number From the
   * poles, the coefficients of denominator polynomial is calculated.
   *
...
#endif  // AUTONOMY_COMMON_SIGNAL_PROCESSING__BUTTERWORTH_HPP_
