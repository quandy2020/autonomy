...
#ifndef AUTONOMY_TRANSFORM_TRANSFORM_HPP_
#define AUTONOMY_TRANSFORM_TRANSFORM_HPP_
...
Eigen::Matrix<T, 3, 1> RotationQuaternionToAngleAxisVector(const Eigen::Quaternion<T>& quaternion) {
    ...
    // We convert the normalized_quaternion into a vector along the rotation
...
#endif  // AUTONOMY_TRANSFORM_TRANSFORM_HPP_
