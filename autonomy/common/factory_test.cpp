...
TEST(FactoryTest, OneArgConstructor) {
    Factory<std::string, ArgConstructor,
            ArgConstructor* (*)(const std::string&)>
        factory;
    EXPECT_TRUE(factory.Register("arg_1", [](const std::string& arg) {
        return new ArgConstructor(arg);
    }));
...
TEST(FactoryTest, TwoArgConstructor) {
    Factory<std::string, ArgConstructor,
        ...
        factory;
    EXPECT_TRUE(
        factory.Register("arg_2", [](const std::string& arg, int value) {
