...
using autonomy::common::state_vector::AngleVariable;
using autonomy::common::state_vector::FloatState;
using autonomy::common::state_vector::GenericState;
using autonomy::common::state_vector::is_state;
...
TEST(KalmanFilterGenericStateTest, Print) {
    ...
    EXPECT_EQ(str_stream.str(),
              "State:\n  autonomy::common::state_vector::variable::X: 42\n"
              "  autonomy::common::state_vector::variable::Y: 23\n");
}
