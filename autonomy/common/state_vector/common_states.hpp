...
#ifndef AUTONOMY_COMMON_STATE_VECTOR_COMMON_STATES_HPP_
#define AUTONOMY_COMMON_STATE_VECTOR_COMMON_STATES_HPP_
...
///
/// @details    All variables have their value, velocity and acceleration. All
...
///
/// @details    All variables in this state have their value, velocity and
/// acceleration. All of
...
///             these variables are assumed to be independent here.
///
/// @note       While any values can be stored in ROLL, PITCH and YAW variables
/// and, strictly
///             speaking, the state itself does not enforce any convention,
///             throughout our code base we use the convention in which ROLL
///             represents a rotation around X axis, PITCH - around Y axis and
///             YAW - around Z axis. Furthermore, they usually represent
///             intrinsic rotation and get applied in ZYX order, i.e., first,
///             the rotation around Z axis is applied, then the rotation around
///             the resulting Y axis, then the rotation around the resulting X
///             axis.
///
template <typename ScalarT>
...
///             vector, angle change rate and acceleration along the rotation
///             vector.
///
/// @details    This state is usually used for the CATR motion model: i.e., a
/// model in which
///             Constant Acceleration and Turn Rate are assumed for a
...
///
/// @details    This state is usually used for the CVTR motion model: i.e., a
/// model in which
///             Constant Velocity and Turn Rate are assumed for a differential
///             drive base.
template <typename ScalarT>
...
#endif  // AUTONOMY_COMMON_STATE_VECTOR_COMMON_STATES_HPP_
