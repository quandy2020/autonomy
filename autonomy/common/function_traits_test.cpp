...
template<
  ...
  typename std::enable_if<
    autonomy::common::function_traits::arity_comparator<Arity, FunctorT>::value>::type * = nullptr
>
...
template<
  typename FunctorT,
  typename std::enable_if<
    autonomy::common::function_traits::check_arguments<FunctorT, int>::value
  >::type * = nullptr
>
int func_accept_callback(FunctorT callback)
{
...
template<
  typename FunctorT,
  typename std::enable_if<
    autonomy::common::function_traits::check_arguments<FunctorT, int, int>::value
  >::type * = nullptr
>
int func_accept_callback(FunctorT callback)
{
...
template<
  typename FunctorT,
  typename std::enable_if<
    autonomy::common::function_traits::check_arguments<FunctorT, int, char>::value
  >::type * = nullptr
>
int func_accept_callback(FunctorT callback)
{
...
template<
  ...
  std::size_t Arity = 0,
  typename std::enable_if<
    autonomy::common::function_traits::arity_comparator<Arity, FunctorT>::value
  >::type * = nullptr,
  typename std::enable_if<
    std::is_same<
      typename autonomy::common::function_traits::function_traits<FunctorT>::return_type,
      double
    >::value
  >::type * = nullptr
>
...
TEST(TestFunctionTraits, arity) {
  ...
  static_assert(
    autonomy::common::function_traits::function_traits<decltype(func_no_args)>::arity == 0,
    "Functor does not accept arguments");

  static_assert(
    autonomy::common::function_traits::function_traits<decltype(func_one_int)>::arity == 1,
    "Functor only accepts one argument");

  static_assert(
    autonomy::common::function_traits::function_traits<decltype(func_two_ints)>::arity == 2,
    "Functor only accepts two arguments");

  static_assert(
    autonomy::common::function_traits::function_traits<decltype(func_one_int_one_char)>::arity == 2,
    "Functor only accepts two arguments");
  ...
  static_assert(
    autonomy::common::function_traits::function_traits<decltype(lambda_no_args)>::arity == 0,
    "Functor does not accept arguments");

  static_assert(
    autonomy::common::function_traits::function_traits<decltype(lambda_one_int)>::arity == 1,
    "Functor only accepts one argument");

  static_assert(
    autonomy::common::function_traits::function_traits<decltype(lambda_two_ints)>::arity == 2,
    "Functor only accepts two arguments");

  static_assert(
    autonomy::common::function_traits::function_traits<decltype(lambda_one_int_one_char)>::arity == 2,
    "Functor only accepts two arguments");

  // Test objects that have a call operator
  static_assert(
    autonomy::common::function_traits::function_traits<FunctionObjectNoArgs>::arity == 0,
    "Functor does not accept arguments");

  static_assert(
    autonomy::common::function_traits::function_traits<FunctionObjectOneInt>::arity == 1,
    "Functor only accepts one argument");

  static_assert(
    autonomy::common::function_traits::function_traits<FunctionObjectTwoInts>::arity == 2,
    "Functor only accepts two arguments");

  static_assert(
    autonomy::common::function_traits::function_traits<FunctionObjectOneIntOneChar>::arity == 2,
    "Functor only accepts two arguments");
}
...
TEST(TestFunctionTraits, argument_types) {
  ...
  static_assert(
    std::is_same<
      int,
      autonomy::common::function_traits::function_traits<decltype(func_one_int)>::template argument_type<0>
    >::value, "Functor accepts an int as first argument");

  static_assert(
    std::is_same<
      int,
      autonomy::common::function_traits::function_traits<decltype(func_two_ints)>::template argument_type<0>
    >::value, "Functor accepts an int as first argument");

  static_assert(
    std::is_same<
      int,
      autonomy::common::function_traits::function_traits<decltype(func_two_ints)>::template argument_type<1>
    >::value, "Functor accepts an int as second argument");

  static_assert(
    std::is_same<
      int,
      autonomy::common::function_traits::function_traits<
  ...
  static_assert(
    std::is_same<
      int,
      autonomy::common::function_traits::function_traits<decltype(lambda_one_int)>::template argument_type<0>
    >::value, "Functor accepts an int as first argument");

  static_assert(
    std::is_same<
      int,
      autonomy::common::function_traits::function_traits<decltype(lambda_two_ints)>::template argument_type<0>
    >::value, "Functor accepts an int as first argument");

  static_assert(
    std::is_same<
      int,
      autonomy::common::function_traits::function_traits<decltype(lambda_two_ints)>::template argument_type<1>
    >::value, "Functor accepts an int as second argument");
  ...
  static_assert(
    std::is_same<
      int,
      autonomy::common::function_traits::function_traits<FunctionObjectOneInt>::template argument_type<0>
    >::value, "Functor accepts an int as first argument");

  static_assert(
    std::is_same<
      int,
      autonomy::common::function_traits::function_traits<FunctionObjectTwoInts>::template argument_type<0>
    >::value, "Functor accepts an int as first argument");

  static_assert(
    std::is_same<
      int,
      autonomy::common::function_traits::function_traits<FunctionObjectTwoInts>::template argument_type<1>
    >::value, "Functor accepts an int as second argument");
  ...
  static_assert(
    std::is_same<
      bool,
      autonomy::common::function_traits::function_traits<decltype(bind_one_bool)>::template argument_type<0>
  ...
  static_assert(
    std::is_same<
      bool,
      autonomy::common::function_traits::function_traits<decltype(bind_one_bool_const)>::template
      argument_type<0>
    >::value, "Functor accepts a bool as first argument");
  ...
  static_assert(
    std::is_same<
      bool,
      autonomy::common::function_traits::function_traits<decltype(bind_two_bools)>::template argument_type<0>
    >::value, "Functor accepts a bool as first argument");

  static_assert(
    std::is_same<
      bool,
      autonomy::common::function_traits::function_traits<decltype(bind_two_bools)>::template argument_type<1>
  ...
  static_assert(
    std::is_same<
      int,
      autonomy::common::function_traits::function_traits<decltype(bind_one_int)>::template argument_type<0>
    >::value, "Functor accepts an int as first argument");
  ...
  static_assert(
    std::is_same<
      int,
      autonomy::common::function_traits::function_traits<decltype(bind_two_ints)>::template argument_type<0>
    >::value, "Functor accepts an int as first argument");

  static_assert(
    std::is_same<
      int,
      autonomy::common::function_traits::function_traits<decltype(bind_two_ints)>::template argument_type<1>
    >::value, "Functor accepts an int as second argument");
...
TEST(TestFunctionTraits, check_arguments) {
  // Test regular functions
  static_assert(
    autonomy::common::function_traits::check_arguments<decltype(func_one_int), int>::value,
    "Functor accepts a single int as arguments");

  static_assert(
    !autonomy::common::function_traits::check_arguments<decltype(func_one_int), char>::value,
    "Functor does not accept a char as argument");

  static_assert(
    !autonomy::common::function_traits::check_arguments<decltype(func_one_int), char, int>::value,
    "Functor does not accept two arguments");

  static_assert(
    !autonomy::common::function_traits::check_arguments<decltype(func_two_ints), int>::value,
    "Functor does not accept a single int as argument, requires two ints");

  static_assert(
    autonomy::common::function_traits::check_arguments<decltype(func_two_ints), int, int>::value,
    "Functor accepts two ints as arguments");

  static_assert(
    !autonomy::common::function_traits::check_arguments<decltype(func_two_ints), bool, int>::value,
    "Functor does not accept a bool and an int as arguments, requires two ints");

  static_assert(
    !autonomy::common::function_traits::check_arguments<decltype(func_two_ints), int, char>::value,
    "Functor does not accept an int and a char as arguments, requires two ints");

  static_assert(
    autonomy::common::function_traits::check_arguments<decltype(func_one_int_one_char), int, char>::value,
  ...
  static_assert(
    autonomy::common::function_traits::check_arguments<decltype(lambda_one_int), int>::value,
    "Functor accepts an int as the only argument");

  static_assert(
    autonomy::common::function_traits::check_arguments<decltype(lambda_two_ints), int, int>::value,
    "Functor accepts two ints as arguments");
  ...
  // Test objects that have a call operator
  static_assert(
    autonomy::common::function_traits::check_arguments<FunctionObjectOneInt, int>::value,
    "Functor accepts an int as the only argument");

  static_assert(
    autonomy::common::function_traits::check_arguments<FunctionObjectTwoInts, int, int>::value,
    "Functor accepts two ints as arguments");

  static_assert(
    autonomy::common::function_traits::check_arguments<FunctionObjectOneIntOneChar, int, char>::value,
    "Functor accepts an int and a char as arguments");
  ...
  static_assert(
    autonomy::common::function_traits::check_arguments<decltype(bind_one_bool), bool>::value,
  ...
  // Test std::bind functions
  static_assert(
    autonomy::common::function_traits::check_arguments<decltype(bind_one_bool_const), bool>::value,
    "Functor accepts a single bool as arguments");
}
...
TEST(TestFunctionTraits, same_arguments) {
  ...
  static_assert(
    autonomy::common::function_traits::same_arguments<
...
TEST(TestFunctionTraits, return_type) {
  ...
  static_assert(
    std::is_same<
      autonomy::common::function_traits::function_traits<decltype(func_no_args)>::return_type,
      int
    >::value,
    "Functor return ints");
  ...
  static_assert(
    std::is_same<
      autonomy::common::function_traits::function_traits<FunctionObjectNoArgs>::return_type,
      int
    >::value,
    "Functor return ints");
}
...
TEST_F(TestMember, bind_member_functor) {
  ...
  static_assert(
    autonomy::common::function_traits::check_arguments<decltype(bind_member_functor), int, float,
    std::string>::value,
