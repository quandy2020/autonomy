...
void Server::Builder::SetNumGrpcThreads(const size_t num_grpc_threads) { options_.num_grpc_threads = num_grpc_threads; }

void Server::Builder::SetNumEventThreads(const std::size_t num_event_threads) {
  options_.num_event_threads = num_event_threads;
}

void Server::Builder::SetServerAddress(const std::string& server_address) { options_.server_address = server_address; }
...
void Server::Shutdown() {
  ...
  // Shut down the server completion queues and wait for the processing
  // threads to join.
  for (auto& completion_queue_threads : completion_queue_threads_) {
