...
#include "autonomy/common/async_grpc/completion_queue_pool.h"

#include <cstdlib>

#include "autonomy/common/async_grpc/async_client.h"
...
CompletionQueuePool::~CompletionQueuePool() { LOG(INFO) << "~CompletionQueuePool"; }
