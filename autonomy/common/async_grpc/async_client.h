 ...
 public:
  ...
  void WriteAsync(const RequestType& request) {
    response_reader_ = std::unique_ptr<::grpc::ClientAsyncResponseReader<ResponseType>>(
        ::grpc::internal::ClientAsyncResponseReaderFactory<ResponseType>::Create(channel_.get(), completion_queue_,
...
template <typename RpcServiceMethodConcept>
class AsyncClient<RpcServiceMethodConcept, ::grpc::internal::RpcMethod::SERVER_STREAMING>
 ...
 public:
  ...
  void WriteAsync(const RequestType& request) {
    ...
    response_reader_ = std::unique_ptr<::grpc::ClientAsyncReader<ResponseType>>(
        ::grpc::internal::ClientAsyncReaderFactory<ResponseType>::Create(channel_.get(), completion_queue_, rpc_method_,
