...
#ifndef AUTONOMY_COMMON_HELPER_FUNCTIONS_MESSAGE_ADAPTERS_HPP_
#define AUTONOMY_COMMON_HELPER_FUNCTIONS_MESSAGE_ADAPTERS_HPP_

#include <string>

#include "autonomy/common/msgs/msgs.hpp"
...
using TimeStamp = builtin_interfaces::Time;
...
/// Get frame id from message. nullptr_t is used to prevent template ambiguity
/// on SFINAE specializations. Provide a default value on specializations for a
/// friendly API.
...
/// SFINAE specializations. Provide a default value on specializations for a
/// friendly API.
/// \tparam T Message type.
/// \param msg Message.
/// \return Frame id of the message.
...
#endif  // AUTONOMY_COMMON_HELPER_FUNCTIONS_MESSAGE_ADAPTERS_HPP_
