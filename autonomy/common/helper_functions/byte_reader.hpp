...
#ifndef AUTONOMY_COMMON_HELPER_FUNCTIONS__BYTE_READER_HPP_
#define AUTONOMY_COMMON_HELPER_FUNCTIONS__BYTE_READER_HPP_
...
public:
    ...
    explicit ByteReader(const std::vector<uint8_t>& byte_vector) : byte_vector_(byte_vector), index_(0U) {}
...
#endif  // AUTONOMY_COMMON_HELPER_FUNCTIONS__BYTE_READER_HPP_
