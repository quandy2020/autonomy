...
constexpr std::array<VisualizationSchemaRule, 39> kSchemaRules = {{
    ...
    {"automsgs.msgs.planning_msgs.Path", "foxglove.PosesInFrame",
     Panel::kThreeD, Strategy::kPayloadAdaptation},
    {"automsgs.msgs.planning_msgs.Odometry", "foxglove.Odometry",
     Panel::kThreeD, Strategy::kPayloadAdaptation},
    ...
    {"automsgs.msgs.map_msgs.Costmap", "foxglove.Grid",
     Panel::kThreeD, Strategy::kPayloadAdaptation},
    {"automsgs.msgs.map_msgs.CostmapUpdate", "foxglove.Grid",
     Panel::kThreeD, Strategy::kPayloadAdaptation},
    {"automsgs.msgs.map_msgs.GridMap", "foxglove.Grid",
     Panel::kThreeD, Strategy::kPayloadAdaptation},
    {"automsgs.msgs.map_msgs.GridCells", "foxglove.SceneUpdate",
     Panel::kThreeD, Strategy::kPayloadAdaptation},
    {"automsgs.msgs.map_msgs.VoxelGrid", "foxglove.VoxelGrid",
     Panel::kThreeD, Strategy::kPayloadAdaptation},
