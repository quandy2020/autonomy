...
public:
	...
	// void publish_by(ros::Publisher& pub, const autonomy::commsgs::std_msgs::Header& header);
...
private:
	...
	autonomy::commsgs::std_msgs::ColorRGBA m_image_boundary_color;
	autonomy::commsgs::std_msgs::ColorRGBA m_optical_center_connector_color;
	double m_scale;
	double m_line_width;
