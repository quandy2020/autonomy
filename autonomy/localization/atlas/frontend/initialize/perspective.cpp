...
#include "autonomy/localization/atlas/frontend/solve/homography_solver.hpp"
#include "autonomy/localization/atlas/frontend/solve/fundamental_solver.hpp"
...
perspective::perspective(const data::frame& ref_frm,
    ...
    ADEBUG << "CONSTRUCT: initialize::perspective";
}

perspective::~perspective() {
    ADEBUG << "DESTRUCT: initialize::perspective";
}
...
bool perspective::reconstruct_with_H(const Mat33_t& H_ref_to_cur, const std::vector<bool>& is_inlier_match) {
    ...
    AINFO << "initialization succeeded with H";
    return true;
}
...
bool perspective::reconstruct_with_F(const Mat33_t& F_ref_to_cur, const std::vector<bool>& is_inlier_match) {
    ...
    AINFO << "initialization succeeded with F";
    return true;
}
