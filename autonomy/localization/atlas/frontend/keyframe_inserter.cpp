...
#include "autonomy/localization/atlas/frontend/marker_initializer.hpp"
#include "autonomy/localization/atlas/frontend/keyframe_inserter.hpp"
...
bool keyframe_inserter::new_keyframe_is_needed(data::map_database* map_db,
    ...
    ADEBUG << "keyframe_inserter: num_reliable_lms_ref=" << num_reliable_lms_ref;
    ADEBUG << "keyframe_inserter: num_reliable_lms=" << num_reliable_lms;
    ADEBUG << "keyframe_inserter: max_interval_elapsed=" << max_interval_elapsed;
    ADEBUG << "keyframe_inserter: max_distance_traveled=" << max_distance_traveled;
    ADEBUG << "keyframe_inserter: view_changed=" << view_changed;
    ADEBUG << "keyframe_inserter: not_enough_lms=" << not_enough_lms;
    ADEBUG << "keyframe_inserter: enough_keyfrms=" << enough_keyfrms;
    ADEBUG << "keyframe_inserter: min_interval_elapsed=" << min_interval_elapsed;
    ADEBUG << "keyframe_inserter: tracking_is_unstable=" << tracking_is_unstable;
    ADEBUG << "keyframe_inserter: almost_all_lms_are_tracked=" << almost_all_lms_are_tracked;
    ADEBUG << "keyframe_inserter: mapper_is_skipping_localBA=" << mapper_is_skipping_localBA;
...
void keyframe_inserter::insert_new_keyframe(data::map_database* map_db,
                                            data::frame& curr_frm) {
    ADEBUG << "keyframe_inserter: insert_new_keyframe (curr_frm=" << curr_frm.id_ << ")";
