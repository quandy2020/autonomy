...
#ifndef AUTONOMY_LOCALIZATION_ATLAS_RELOCALIZATION_RELOCALIZER_HPP_
#define AUTONOMY_LOCALIZATION_ATLAS_RELOCALIZATION_RELOCALIZER_HPP_
...
/**
 * BoW / PnP relocalization. Runs synchronously on the tracking thread
 * (Frontend sync is plan-OK). Heavy BoW is not Schedule'd on ThreadPool yet.
 */
class Relocalizer {
public:
    //! Constructor
...
namespace module {
using relocalizer = relocalization::Relocalizer;
}  // namespace module

}  // namespace autonomy::localization::atlas

#endif  // AUTONOMY_LOCALIZATION_ATLAS_RELOCALIZATION_RELOCALIZER_HPP_
