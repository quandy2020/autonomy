...
#include "autonomy/localization/atlas/port/core/lio/anderson_acceleration.hpp"
...
class ESKF {
   ...
   public:
    ...
    struct Options {
        ...
        double max_update_translation_step_ = 5.0;
        double max_update_rotation_step_deg_ = 20.0;
        double max_update_velocity_step_ = 4.0;
    };
