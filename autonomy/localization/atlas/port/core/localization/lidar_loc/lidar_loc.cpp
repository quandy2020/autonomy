...
LidarLoc::LidarLoc(LidarLoc::Options options) : options_(options) {
    ...
    pcl_ndt_->setNeighborhoodSearchMethod(atlas_pclomp::DIRECT7);
    ...
    pcl_ndt_rough_->setNeighborhoodSearchMethod(atlas_pclomp::DIRECT7);
...
bool LidarLoc::UpdateGlobalMap() {
    ...
    ndt->setNeighborhoodSearchMethod(atlas_pclomp::DIRECT7);
    ndt->setStepSize(0.1);
    ...
    if (!loc_inited_) {
        ...
        ndt_rough->setNeighborhoodSearchMethod(atlas_pclomp::DIRECT7);
