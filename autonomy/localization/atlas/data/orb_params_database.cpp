...
orb_params_database::orb_params_database() {
    ADEBUG << "CONSTRUCT: data::orb_params_database";
}
...
orb_params_database::~orb_params_database() {
    ...
    ADEBUG << "DESTRUCT: data::orb_params_database";
}
...
void orb_params_database::from_json(const nlohmann::json& json_orb_params) {
    ...
    AINFO << "decoding " << json_orb_params.size() << " orb_params to load";
    for (const auto& json_id_orb_params : json_orb_params.items()) {
        ...
        if (orb_params_database_.count(orb_params_name)) {
            AINFO << "The feature extraction settings with the same name ("" << orb_params_name << "") already existed in database.";
        ...
        AINFO << "load a orb_params "" << orb_params_name << "" from JSON";
...
nlohmann::json orb_params_database::to_json() const {
    ...
    AINFO << "encoding " << orb_params_database_.size() << " orb_params to store";
