...
#include "autonomy/localization/atlas/optimize/internal/marker_vertex_container.hpp"
...
void local_bundle_adjuster_g2o::optimize(data::map_database* map_db,
                                         const std::shared_ptr<autonomy::localization::atlas::data::keyframe>& curr_keyfrm, bool* const force_stop_flag) const {
