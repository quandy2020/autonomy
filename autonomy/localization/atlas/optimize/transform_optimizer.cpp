...
#include "autonomy/localization/atlas/optimize/transform_optimizer.hpp"
#include "autonomy/localization/atlas/optimize/internal/sim3/transform_vertex.hpp"
#include "autonomy/localization/atlas/optimize/internal/sim3/mutual_reproj_edge_wrapper.hpp"
...
unsigned int transform_optimizer::optimize(const std::shared_ptr<data::keyframe>& keyfrm_1, const std::shared_ptr<data::keyframe>& keyfrm_2,
    ...
    auto linear_solver = autonomy::localization::atlas::make_unique<g2o::LinearSolverEigen<g2o::BlockSolverX::PoseMatrixType>>();
