        ...
        namespace plp_g2o
        {
            namespace se3
            {
                ...
                class reproj_edge_line3d
                    : public ::g2o::BaseBinaryEdge<2, Vec4_t, internal::se3::shot_vertex, VertexLine3D>
                {
                public:
                    EIGEN_MAKE_ALIGNED_OPERATOR_NEW;

                    reproj_edge_line3d()
                        : ::g2o::BaseBinaryEdge<2, Vec4_t, internal::se3::shot_vertex, VertexLine3D>() {}
                    ...
                    {
                        const internal::se3::shot_vertex* se3Vertex =
                            static_cast<const internal::se3::shot_vertex*>(_vertices[0]);
