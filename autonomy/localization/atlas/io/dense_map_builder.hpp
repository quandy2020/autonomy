...
#include "autonomy/localization/atlas/io/cloud_map.hpp"
#include "autonomy/localization/atlas/io/elevation_map.hpp"
#include "autonomy/localization/atlas/io/local_grid.hpp"
#include "autonomy/localization/atlas/io/local_grid_maker.hpp"
#include "autonomy/localization/atlas/io/occupancy_grid_map.hpp"
#include "autonomy/localization/atlas/io/octree_map.hpp"
...
public:
    ...
    //! Mark dense map for reassembly after loop BA (consumed on next Integrate).
    void RequestRebuild() { needs_refresh_.store(true, std::memory_order_release); }
    //! Optional ThreadPool handle for Task-based rebuild scheduling.
    void ScheduleOn(::autonomy::common::ThreadPool* pool);
    //! Schedule a no-op / RequestRebuild marker on the attached pool.
    void ScheduleIntegrate();
...
private:
    ...
    ::autonomy::common::ThreadPool* schedule_pool_ = nullptr;
};
