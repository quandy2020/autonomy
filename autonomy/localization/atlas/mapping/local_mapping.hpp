...
#ifndef AUTONOMY_LOCALIZATION_ATLAS_MAPPING_MODULE_HPP_
#define AUTONOMY_LOCALIZATION_ATLAS_MAPPING_MODULE_HPP_
...
#include "autonomy/localization/atlas/frontend/local_map_cleaner.hpp"
...
public:
    ...
    //! Inject residual mask / sources for joint Local BA.
...
private:
    ...
    //! Schedule a single drain Task on thread_pool_ (serialized).
    void MaybeScheduleDrain();

    //! Process queued keyframes until empty / terminate.
    ...
    //! Live lidar local map (IVox); owned here, borrowed by LidarSensor.
...
#endif  // AUTONOMY_LOCALIZATION_ATLAS_MAPPING_MODULE_HPP_
