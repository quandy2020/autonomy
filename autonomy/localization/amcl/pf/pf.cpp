...
//     pf = static_cast<pf_t*>(calloc(1, sizeof(pf_t)));
...
//     set->samples = static_cast<pf_sample_t*>(calloc(max_samples, sizeof(pf_sample_t)));
...
//     set->clusters = static_cast<pf_cluster_t*>(calloc(set->cluster_max_count, sizeof(pf_cluster_t)));
