...
//! LiDAR-inertial frontend: IMU propagate + voxel local map accumulation.
class LioFrontend : public FrontendBase {
 public:
  ...
  void Reset() override;
  FrontendMode Mode() const override { return FrontendMode::kLio; }
