...
Submap3D::Submap3D(const float high_resolution, const float low_resolution, const transform::Rigid3d& local_submap_pose,
    ...
    : Submap(local_submap_pose),
      high_resolution_hybrid_grid_(std::make_unique<HybridGrid>(high_resolution)),
      low_resolution_hybrid_grid_(std::make_unique<HybridGrid>(low_resolution)),
      high_resolution_intensity_hybrid_grid_(std::make_unique<IntensityHybridGrid>(high_resolution)),
...
void Submap3D::UpdateFromProto(const proto::Submap3D& submap_3d) {
    ...
    if (submap_3d.has_high_resolution_hybrid_grid()) {
        high_resolution_hybrid_grid_ = std::make_unique<HybridGrid>(submap_3d.high_resolution_hybrid_grid());
    }
    if (submap_3d.has_low_resolution_hybrid_grid()) {
        low_resolution_hybrid_grid_ = std::make_unique<HybridGrid>(submap_3d.low_resolution_hybrid_grid());
    }
