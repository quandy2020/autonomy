...
void PopulatePureLocalizationTrimmerOptions(
    ...
    auto options_dictionary =
        parameter_dictionary->GetDictionary(kDictionaryKey);
    auto* options =
...
proto::SensorId ToProto(const TrajectoryBuilderInterface::SensorId& sensor_id) {
    ...
    switch (sensor_id.type) {
        ...
        case TrajectoryBuilderInterface::SensorId::SensorType::LANDMARK:
            ...
            break;
        case TrajectoryBuilderInterface::SensorId::SensorType::
            LOCAL_SLAM_RESULT:
...
TrajectoryBuilderInterface::SensorId FromProto(
    ...
    switch (sensor_id_proto.type()) {
        case proto::SensorId::RANGE:
            sensor_id.type =
                TrajectoryBuilderInterface::SensorId::SensorType::RANGE;
            break;
        case proto::SensorId::IMU:
            sensor_id.type =
                TrajectoryBuilderInterface::SensorId::SensorType::IMU;
            break;
        ...
        case proto::SensorId::FIXED_FRAME_POSE:
            sensor_id.type = TrajectoryBuilderInterface::SensorId::SensorType::
                FIXED_FRAME_POSE;
            break;
