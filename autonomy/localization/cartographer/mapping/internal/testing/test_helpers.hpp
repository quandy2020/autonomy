...
proto::Submap CreateFakeSubmap3D(int trajectory_id = 1, int submap_index = 1, bool finished = true);
...
void AddToProtoGraph(const proto::PoseGraph::LandmarkPose& landmark_node, proto::PoseGraph* pose_graph);
