...
#include "autonomy/localization/cartographer/mapping/internal/connected_components.hpp"
...
public:
    ...
    // tracked. This function is invariant to the order of its arguments.
    // Repeated calls to Connect increment the connectivity count and update the
    // last connected time.
    ...
    // Return the last connection count between the two trajectories. If either
    // of the trajectories is untracked or they have never been connected
    // returns the beginning of time.
