...
public:
    static ceres::CostFunction* CreateAutoDiffCostFunction(
        ...
        return new ceres::AutoDiffCostFunction<
            ...
            new AccelerationCostFunction3D(
                scaling_factor, delta_velocity_imu_frame,
                first_delta_time_seconds, second_delta_time_seconds));
    }

    template <typename T>
    bool operator()(const T* const middle_rotation,
        ...
        const Eigen::Matrix<T, 3, 1> imu_delta_velocity =
            ...
            *gravity_constant *
                (0.5 *
                 (first_delta_time_seconds_ + second_delta_time_seconds_) *
