...
public:
    static ceres::CostFunction* CreateAutoDiffCostFunction(
        ...
        return new ceres::AutoDiffCostFunction<
            RotationCostFunction3D, 3 /* residuals */,
            4 /* rotation variables */, 4 /* rotation variables */,
            4 /* rotation variables */
            >(new RotationCostFunction3D(scaling_factor,
    ...
    bool operator()(const T* const start_rotation, const T* const end_rotation,
        ...
        const Eigen::Quaternion<T> eigen_imu_calibration(
            ...
            imu_calibration[3]);
        const Eigen::Quaternion<T> error = end.conjugate() * start *
                                           eigen_imu_calibration *
                                           delta_rotation_imu_frame_.cast<T>() *
                                           eigen_imu_calibration.conjugate();
