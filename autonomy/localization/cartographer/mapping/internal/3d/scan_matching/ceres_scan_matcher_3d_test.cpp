 ...
 protected:
  CeresScanMatcher3DTest()
    ...
    for (const Eigen::Vector3f& point :
      ...
      intensity_hybrid_grid_.AddIntensity(intensity_hybrid_grid_.GetCellIndex(expected_pose_.cast<float>() * point),
                                          50);
    }
...
TEST_F(CeresScanMatcher3DTest, FullPoseCorrection) {
  ...
  const auto additional_transform = transform::Rigid3d::Rotation(Eigen::AngleAxisd(0.05, Eigen::Vector3d(0., 0., 1.)));
