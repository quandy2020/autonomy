...
TSDF2D::TSDF2D(const MapLimits& limits, float truncation_distance, float max_weight,
    ...
    : Grid2D(limits, -truncation_distance, truncation_distance, conversion_tables),
      ...
      value_converter_(std::make_unique<TSDValueConverter>(truncation_distance, max_weight, conversion_tables_)),
...
TSDF2D::TSDF2D(const proto::Grid2D& proto, ValueConversionTables* conversion_tables)
    ...
    value_converter_ = std::make_unique<TSDValueConverter>(proto.tsdf_2d().truncation_distance(),
...
std::unique_ptr<Grid2D> TSDF2D::ComputeCroppedGrid() const {
    ...
    std::unique_ptr<TSDF2D> cropped_grid =
        std::make_unique<TSDF2D>(MapLimits(resolution, max, cell_limits), value_converter_->getMaxTSD(),
