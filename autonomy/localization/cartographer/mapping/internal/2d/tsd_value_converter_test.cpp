...
TEST_F(TSDValueConverterTest, ValueToTSDConversionsWithUpdateMarker) {
    for (uint16 i = 1; i < 32768; ++i) {
        EXPECT_EQ(tsd_value_converter_.TSDToValue(
                      tsd_value_converter_.ValueToTSD(i + tsd_value_converter_.getUpdateMarker())),
                  i);
    }
}
...
TEST_F(TSDValueConverterTest, TSDToValueConversions) {
    ...
    for (uint16 i = 0; i < num_samples; ++i) {
        ...
        EXPECT_NEAR(tsd_value_converter_.ValueToTSD(tsd_value_converter_.TSDToValue(sdf_sample)), sdf_sample,
                    tolerance);
    }
}
...
TEST_F(TSDValueConverterTest, WeightToValueConversions) {
    ...
    for (uint16 i = 0; i < num_samples; ++i) {
        ...
        EXPECT_NEAR(tsd_value_converter_.ValueToWeight(tsd_value_converter_.WeightToValue(weight_sample)),
