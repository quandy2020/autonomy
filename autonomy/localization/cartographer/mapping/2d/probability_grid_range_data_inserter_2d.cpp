...
#include "autonomy/localization/cartographer/mapping/2d/xy_index.hpp"
...
void CastRays(const sensor::RangeData& range_data, const std::vector<uint16>& hit_table,
              const std::vector<uint16>& miss_table, const bool insert_free_space, ProbabilityGrid* probability_grid) {
