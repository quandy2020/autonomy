...
void MigrateStreamVersion1ToVersion2(cartographer::io::ProtoStreamReaderInterface* const input,
    ...
    while (deserializer.ReadNextSerializedData(&proto)) {
        switch (proto.data_case()) {
            ...
            case SerializedData::kSubmap: {
                ...
                submap_id_to_submap.Insert(mapping::SubmapId{proto.submap().submap_id().trajectory_id(),
    ...
    if (deserializer.header().format_version() == kFormatVersionWithoutSubmapHistograms) {
        submap_id_to_submap =
            MigrateSubmapFormatVersion1ToVersion2(submap_id_to_submap, node_id_to_node, pose_graph_proto);
    }
