...
void MigrateStreamVersion1ToVersion2(
    ...
    for (const mapping::proto::Trajectory& trajectory_proto :
        ...
        for (const mapping::proto::Trajectory::Submap& submap_proto :
            ...
            submap_poses.Insert(
                mapping::SubmapId{trajectory_proto.trajectory_id(),
        ...
        switch (proto.data_case()) {
            ...
            case SerializedData::kSubmap: {
                CHECK(proto.submap().has_submap_3d())
                    << "Converting to the new submap format only makes sense "
                       "for 3D.";
...
MigrateSubmapFormatVersion1ToVersion2(
    ...
    for (const proto::PoseGraph::Constraint& constraint_proto :
        ...
        if (constraint_proto.tag() ==
            ...
            proto::Submap& migrated_submap_proto =
            ...
            const double submap_yaw_from_gravity = transform::GetYaw(
                transform::ToRigid3(submap_3d_proto->local_pose())
                    .inverse()
                    .rotation() *
            ...
            if (submap_3d_proto->rotational_scan_matcher_histogram_size() ==
                0) {
                for (Eigen::VectorXf::Index i = 0;
                     i != rotational_scan_matcher_histogram_in_submap.size();
                     ++i) {
