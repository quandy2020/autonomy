...
#include "autonomy/localization/cartographer/io/fake_file_writer.hpp"
...
std::unique_ptr<PointsBatch> CreatePointsBatch() {
    auto points_batch = ::std::make_unique<PointsBatch>();
...
::cartographer::io::FileWriterFactory CreateFakeFileWriterFactory(
    ...
    return [&fake_file_writer_output, &expected_filename](const std::string& full_filename) {
        ...
        return ::std::make_unique<::cartographer::io::FakeFileWriter>(full_filename, fake_file_writer_output);
    };
}
...
std::vector<std::unique_ptr<::cartographer::io::PointsProcessor>> CreatePipelineFromDictionary(
    ...
    auto builder = ::std::make_unique<::cartographer::io::PointsProcessorPipelineBuilder>();
    builder->Register(
...
std::unique_ptr<common::LuaParameterDictionary> CreateParameterDictionary() {
    auto parameter_dictionary = cartographer::common::LuaParameterDictionary::NonReferenceCounted(
        ...
        std::make_unique<cartographer::common::DummyFileResolver>());
