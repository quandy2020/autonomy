...
std::unique_ptr<ColoringPointsProcessor> ColoringPointsProcessor::FromDictionary(
  ...
  const Uint8Color color = {
      {static_cast<uint8>(color_values[0]), static_cast<uint8>(color_values[1]), static_cast<uint8>(color_values[2])}};
...
PointsProcessor::FlushResult ColoringPointsProcessor::Flush() { return next_->Flush(); }
