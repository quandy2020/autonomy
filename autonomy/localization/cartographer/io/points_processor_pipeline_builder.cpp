...
#include "autonomy/localization/cartographer/io/points_processor_pipeline_builder.hpp"

#include "absl/memory/memory.h"
#include "autonomy/localization/cartographer/io/coloring_points_processor.hpp"
#include "autonomy/localization/cartographer/io/counting_points_processor.hpp"
#include "autonomy/localization/cartographer/io/fixed_ratio_sampling_points_processor.hpp"
#include "autonomy/localization/cartographer/io/frame_id_filtering_points_processor.hpp"
#include "autonomy/localization/cartographer/io/hybrid_grid_points_processor.hpp"
#include "autonomy/localization/cartographer/io/intensity_to_color_points_processor.hpp"
#include "autonomy/localization/cartographer/io/min_max_range_filtering_points_processor.hpp"
#include "autonomy/localization/cartographer/io/null_points_processor.hpp"
#include "autonomy/localization/cartographer/io/outlier_removing_points_processor.hpp"
#include "autonomy/localization/cartographer/io/pcd_writing_points_processor.hpp"
#include "autonomy/localization/cartographer/io/ply_writing_points_processor.hpp"
#include "autonomy/localization/cartographer/io/probability_grid_points_processor.hpp"
#include "autonomy/localization/cartographer/io/vertical_range_filtering_points_processor.hpp"
#include "autonomy/localization/cartographer/io/xray_points_processor.hpp"
#include "autonomy/localization/cartographer/io/xyz_writing_points_processor.hpp"
...
void RegisterBuiltInPointsProcessors(
    ...
    RegisterPlainPointsProcessor<VerticalRangeFilteringPointsProcessor>(
        builder);
...
PointsProcessorPipelineBuilder::CreatePipeline(
    ...
    std::vector<std::unique_ptr<common::LuaParameterDictionary>>
        configurations = dictionary->GetArrayValuesAsDictionaries();
    ...
    for (auto it = configurations.rbegin(); it != configurations.rend(); it++) {
        ...
        pipeline.push_back(
            factory_it->second(it->get(), pipeline.back().get()));
    }
    return pipeline;
}
