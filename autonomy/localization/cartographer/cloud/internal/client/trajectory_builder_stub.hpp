...
private:
    static void RunLocalSlamResultsReader(
        autonomy::common::async_grpc::Client<
            handlers::ReceiveLocalSlamResultsSignature>* client_reader,
        LocalSlamResultCallback local_slam_result_callback);

    std::shared_ptr<::grpc::Channel> client_channel_;
    const int trajectory_id_;
    const std::string client_id_;
    std::unique_ptr<autonomy::common::async_grpc::Client<
        handlers::AddRangefinderDataSignature>>
        add_rangefinder_client_;
    std::unique_ptr<
        autonomy::common::async_grpc::Client<handlers::AddImuDataSignature>>
        add_imu_client_;
    std::unique_ptr<autonomy::common::async_grpc::Client<
