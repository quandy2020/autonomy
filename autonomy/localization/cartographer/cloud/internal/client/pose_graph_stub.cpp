...
void PoseGraphStub::RunFinalOptimization() {
    ...
    autonomy::common::async_grpc::Client<
        handlers::RunFinalOptimizationSignature>
...
PoseGraphStub::GetAllSubmapPoses() const {
    google::protobuf::Empty request;
    autonomy::common::async_grpc::Client<handlers::GetAllSubmapPosesSignature>
        client(client_channel_);
    CHECK(client.Write(request));
    mapping::MapById<mapping::SubmapId, mapping::PoseGraphInterface::SubmapPose>
        submap_poses;
...
transform::Rigid3d PoseGraphStub::GetLocalToGlobalTransform(
    ...
    autonomy::common::async_grpc::Client<
        handlers::GetLocalToGlobalTransformSignature>
        client(client_channel_);
    CHECK(client.Write(request));
...
PoseGraphStub::GetTrajectoryNodePoses() const {
    google::protobuf::Empty request;
    autonomy::common::async_grpc::Client<
        handlers::GetTrajectoryNodePosesSignature>
        client(client_channel_);
    CHECK(client.Write(request));
        ...
        if (node_pose.has_constant_pose_data()) {
            constant_pose_data = mapping::TrajectoryNodePose::ConstantPoseData{
                common::FromUniversal(
                    node_pose.constant_pose_data().timestamp()),
                transform::ToRigid3(
                    node_pose.constant_pose_data().local_pose())};
        }
...
PoseGraphStub::GetTrajectoryStates() const {
    google::protobuf::Empty request;
    autonomy::common::async_grpc::Client<handlers::GetTrajectoryStatesSignature>
        client(client_channel_);
    CHECK(client.Write(request));
    std::map<int, mapping::PoseGraphInterface::TrajectoryState>
        trajectories_state;
...
std::map<std::string, transform::Rigid3d> PoseGraphStub::GetLandmarkPoses()
    const {
    google::protobuf::Empty request;
    autonomy::common::async_grpc::Client<handlers::GetLandmarkPosesSignature>
        client(client_channel_);
    CHECK(client.Write(request));
...
void PoseGraphStub::SetLandmarkPose(const std::string& landmark_id,
    ...
    *request.mutable_landmark_pose()->mutable_global_pose() =
    ...
    autonomy::common::async_grpc::Client<handlers::SetLandmarkPoseSignature>
        client(client_channel_);
    CHECK(client.Write(request));
}
...
void PoseGraphStub::DeleteTrajectory(int trajectory_id) {
    ...
    request.set_trajectory_id(trajectory_id);
    autonomy::common::async_grpc::Client<handlers::DeleteTrajectorySignature>
        client(client_channel_);
    ::grpc::Status status;
...
bool PoseGraphStub::IsTrajectoryFinished(int trajectory_id) const {
    ...
    request.set_trajectory_id(trajectory_id);
    autonomy::common::async_grpc::Client<
        handlers::IsTrajectoryFinishedSignature>
        client(client_channel_);
    ::grpc::Status status;
...
bool PoseGraphStub::IsTrajectoryFrozen(int trajectory_id) const {
    ...
    request.set_trajectory_id(trajectory_id);
    autonomy::common::async_grpc::Client<handlers::IsTrajectoryFrozenSignature>
        client(client_channel_);
    ::grpc::Status status;
    CHECK(client.Write(request, &status))
        << "Failed to check if trajectory " << trajectory_id
...
PoseGraphStub::constraints() const {
    google::protobuf::Empty request;
    autonomy::common::async_grpc::Client<handlers::GetConstraintsSignature>
        client(client_channel_);
    ::grpc::Status status;
    CHECK(client.Write(request, &status))
