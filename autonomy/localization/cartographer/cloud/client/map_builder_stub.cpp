...
int MapBuilderStub::AddTrajectoryBuilder(const std::set<SensorId>& expected_sensor_ids,
  ...
  *request.mutable_trajectory_builder_options() = trajectory_options;
  ...
  autonomy::common::async_grpc::Client<handlers::AddTrajectorySignature> client(
      ...
      autonomy::common::async_grpc::CreateLimitedBackoffStrategy(common::FromMilliseconds(kRetryBaseDelayMilliseconds),
...
int MapBuilderStub::num_trajectory_builders() const { return trajectory_builder_stubs_.size(); }

mapping::PoseGraphInterface* MapBuilderStub::pose_graph() { return pose_graph_stub_.get(); }
