...
bool TransformInterpolationBuffer::empty() const { return timestamped_transforms_.empty(); }

size_t TransformInterpolationBuffer::size_limit() const { return buffer_size_limit_; }

size_t TransformInterpolationBuffer::size() const { return timestamped_transforms_.size(); }
