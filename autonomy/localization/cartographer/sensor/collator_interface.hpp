...
public:
    ...
    virtual void AddTrajectory(int trajectory_id, const std::unordered_set<std::string>& expected_sensor_ids,
    ...
    virtual std::optional<int> GetBlockingTrajectoryId() const = 0;
};
