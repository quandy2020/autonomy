...
#include "Eigen/Core"
#include "autonomy/localization/cartographer/sensor/proto/sensor.pb.h"
#include "autonomy/localization/cartographer/sensor/rangefinder_point.hpp"
...
public:
    ...
    PointCloud copy_if(UnaryPredicate predicate) const {
        ...
        // Note: benchmarks show that it is better to have this conditional
        // outside the loop.
