...
std::optional<int> TrajectoryCollator::GetBlockingTrajectoryId() const {
...
metrics::Counter* TrajectoryCollator::GetOrCreateSensorMetric(const std::string& sensor_id, int trajectory_id) {
    const std::string trajectory_id_str = autonomy::common::StrCat(trajectory_id);
    const std::string map_key = autonomy::common::StrCat(sensor_id, "/", trajectory_id_str);
