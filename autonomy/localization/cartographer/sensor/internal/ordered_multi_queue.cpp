...
#include "autonomy/localization/cartographer/sensor/internal/ordered_multi_queue.hpp"
    ...
    while (true) {
        ...
        for (auto it = queues_.begin(); it != queues_.end();) {
            ...
            if (next_data == nullptr ||
                data->GetTime() < next_data->GetTime()) {
                next_data = data;
        ...
        // forward all queues of this trajectory until a common start time has
        // been reached.
        ...
        if (next_data->GetTime() >= common_start_time) {
            ...
            // beyond 'common_start_time' we drop 'next_data', otherwise we just
            // found the first packet to dispatch from this queue.
