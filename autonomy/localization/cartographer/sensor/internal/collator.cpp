...
void Collator::AddTrajectory(const int trajectory_id, const std::unordered_set<std::string>& expected_sensor_ids,
...
std::optional<int> Collator::GetBlockingTrajectoryId() const {
    return std::optional<int>(queue_.GetBlocker().trajectory_id);
}
