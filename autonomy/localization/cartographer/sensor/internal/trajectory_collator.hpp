...
#include "autonomy/localization/cartographer/sensor/collator_interface.hpp"
...
public:
    ...
    void AddTrajectory(int trajectory_id, const std::unordered_set<std::string>& expected_sensor_ids,
    ...
    std::optional<int> GetBlockingTrajectoryId() const override;
