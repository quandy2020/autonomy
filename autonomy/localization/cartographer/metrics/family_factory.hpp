...
class NullFamily : public Family<MetricType> {
 public:
  MetricType* Add(const std::map<std::string, std::string>& labels) override { return MetricType::Null(); }
};
...
class FamilyFactory {
 public:
  ...
  virtual Family<Histogram>* NewHistogramFamily(const std::string& name, const std::string& description,
