...
#ifndef AUTONOMY_TASK_COMMON_NAMES_HPP_
#define AUTONOMY_TASK_COMMON_NAMES_HPP_
...
constexpr char kGoalPoses[] = "/goal_poses";
constexpr char kCancelNavigation[] = "/cancel_navigation";
...
#endif  // AUTONOMY_TASK_COMMON_NAMES_HPP_
