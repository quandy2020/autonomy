...
/**
 * @class teleop::TeleopPerceptionOkCondition
 * @brief BT condition PerceptionValid: delegate to TeleopClient::IsPerceptionOk
 */
class TeleopPerceptionOkCondition : public BtCondition
{
public:
    /**
     * @brief Construct PerceptionValid BT condition node
     */
...
protected:
    /**
     * @brief Evaluate PerceptionValid BT condition
     */
