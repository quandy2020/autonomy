...
class SetInitialPoseAction : public BtSyncAction
{
public:
    SetInitialPoseAction(const std::string& name, const BT::NodeConfig& config)
...
protected:
    BT::NodeStatus OnExecute() override
    {
        ...
        return (client && client->SetInitialPose()) ? BT::NodeStatus::SUCCESS
...
BT_REGISTER_NODES(factory)
{
    factory.registerNodeType<
        autonomy::task::plugins::mapping::SetInitialPoseAction>(
        "SetInitialPose");
}
