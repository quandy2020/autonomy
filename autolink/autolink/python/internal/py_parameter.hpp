...
public:
    ...
    int64_t as_int64() {
        return parameter_.AsInt64();
    }
    double as_double() {
        return parameter_.AsDouble();
    }
    std::string as_string() {
        return parameter_.AsString();
    }
    std::string debug_string() {
        return parameter_.DebugString();
    }
