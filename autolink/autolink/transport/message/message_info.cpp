...
bool MessageInfo::SerializeTo(std::string* dst) const {
    ...
    dst->append(reinterpret_cast<const char*>(&msg_seq_num_),
                sizeof(msg_seq_num_));
...
bool MessageInfo::SerializeTo(char* dst, std::size_t len) const {
    ...
    ptr += ID_SIZE;
    std::memcpy(ptr, reinterpret_cast<const char*>(&msg_seq_num_),
                sizeof(msg_seq_num_));
...
bool MessageInfo::DeserializeFrom(const char* src, std::size_t len) {
    ...
    ptr += ID_SIZE;
    std::memcpy(reinterpret_cast<char*>(&msg_seq_num_), ptr,
                sizeof(msg_seq_num_));
    ptr += sizeof(msg_seq_num_);
