...
RecordViewer::Iterator RecordViewer::begin() {
    return Iterator(this);
}

RecordViewer::Iterator RecordViewer::end() {
    return Iterator(this, true);
}

RecordViewer::Iterator RecordViewer::curr_itr() {
    return itr_;
}

void RecordViewer::set_curr_itr(const Iterator& curr_itr) {
    itr_ = curr_itr;
}
...
bool RecordViewer::FillBuffer() {
    while (curr_begin_time_ <= end_time_ &&
           msg_buffer_.size() < kBufferMinSize) {
