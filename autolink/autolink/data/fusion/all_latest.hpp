...
#include "autolink/data/channel_buffer.hpp"
#include "autolink/data/fusion/data_fusion.hpp"
...
class AllLatest : public DataFusion<M0, M1, M2, M3> {
  using FusionDataType = std::tuple<std::shared_ptr<M0>, std::shared_ptr<M1>, std::shared_ptr<M2>, std::shared_ptr<M3>>;
 ...
 public:
  AllLatest(const ChannelBuffer<M0>& buffer_0, const ChannelBuffer<M1>& buffer_1, const ChannelBuffer<M2>& buffer_2,
      ...
      : buffer_m0_(buffer_0),
        ...
        buffer_fusion_(buffer_m0_.channel_id(),
                       new CacheBuffer<std::shared_ptr<FusionDataType>>(buffer_0.Buffer()->Capacity() - uint64_t(1))) {
  ...
  bool Fusion(uint64_t* index, std::shared_ptr<M0>& m0, std::shared_ptr<M1>& m1, std::shared_ptr<M2>& m2,
...
class AllLatest<M0, M1, M2, NullType> : public DataFusion<M0, M1, M2> {
  using FusionDataType = std::tuple<std::shared_ptr<M0>, std::shared_ptr<M1>, std::shared_ptr<M2>>;
