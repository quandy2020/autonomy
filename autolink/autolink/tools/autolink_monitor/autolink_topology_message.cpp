...
AutolinkTopologyMessage::AutolinkTopologyMessage(const std::string& channel)
...
AutolinkTopologyMessage::~AutolinkTopologyMessage(void) {
...
bool AutolinkTopologyMessage::IsFromHere(const std::string& node_name) {
...
RenderableMessage* AutolinkTopologyMessage::Child(int line_no) const {
...
AutolinkTopologyMessage::FindChild(int line_no) const {
    --line_no;
...
void AutolinkTopologyMessage::TopologyChanged(
...
void AutolinkTopologyMessage::AddReaderWriter(
...
void AutolinkTopologyMessage::ChangeState(const Screen* s, int key) {
    switch (key) {
        case 'f':
        case 'F':
            second_column_ = SecondColumnType::MessageFrameRatio;
...
int AutolinkTopologyMessage::Render(const Screen* s, int key) {
