...
using autolink::proto::Param;
using autolink::proto::ParamType;

/**
 * @class Parameter
 * @brief A `Parameter` holds an autolink::autolink::proto::Param,
...
public:
    ...
    /**
     * @brief Parse a autolink::proto::Param object to
     * autolink::parameter::Parameter object
     * @param param The autolink::proto::Param object parse from
    ...
    /**
     * @brief Parse a autolink::parameter::Parameter object to
     * autolink::proto::Param object
     * @return The target autolink::proto::Param object
     */
    Param ToProtoParam() const;

    /**
     * @brief Get the autolink:parameter::ParamType of this object
     * @return result autolink:parameter::ParameterType
     */
...
inline ParamType Parameter::Type() const {
    return param_.type();
}

inline std::string Parameter::TypeName() const {
    return param_.type_name();
}

inline std::string Parameter::Descriptor() const {
    return param_.proto_desc();
}
...
inline int64_t Parameter::AsInt64() const {
