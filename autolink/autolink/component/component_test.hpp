...
#include "autolink/transport/message/raw_message.hpp"
...
private:
    bool Proc(const std::shared_ptr<M0>&) {
        return ret_proc;
    }
};
...
TEST(CommonComponent, init) {
    ret_proc = true;
    ret_init = true;
    autolink::proto::ComponentConfig compcfg;
    ...
    autolink::proto::ReaderOption* read_opt = compcfg.add_readers();
    ...
    autolink::proto::ReaderOption* read_opt2 = compcfg.add_readers();
    ...
    autolink::proto::ReaderOption* read_opt3 = compcfg.add_readers();
