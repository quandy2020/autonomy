...
#ifndef CLASS_LOADER_PLUGIN1_PATH
#error "CLASS_LOADER_PLUGIN1_PATH is not defined"
#endif
#ifndef CLASS_LOADER_PLUGIN2_PATH
#error "CLASS_LOADER_PLUGIN2_PATH is not defined"
#endif

static constexpr char LIBRARY_1[] = CLASS_LOADER_PLUGIN1_PATH;
static constexpr char LIBRARY_2[] = CLASS_LOADER_PLUGIN2_PATH;
...
TEST(ClassLoaderTest, util_test) {
    ClassLoader loader1(LIBRARY_1);
    autolink::class_loader::utility::LoadLibrary("1", &loader1);
    autolink::class_loader::utility::UnloadLibrary("1", nullptr);
    autolink::class_loader::utility::IsLibraryLoaded(LIBRARY_1, &loader1);
    autolink::class_loader::utility::IsLibraryLoaded(LIBRARY_2, &loader1);
}