...
TEST_F(ChannelManagerTest, get_proto_desc) {
    ...
    std::string tmp("");
    proto::Chatter chatter_msg;
    message::ProtobufFactory::GetDescriptorString(chatter_msg, &tmp);
...
TEST_F(ChannelManagerTest, is_message_type_matching) {
    message::RawMessage raw_msg_1;
    const std::string raw_msg_type_1 = message::MessageType(raw_msg_1);
    message::PyMessageWrap py_msg;
    const std::string py_msg_type = message::MessageType(py_msg);
    proto::Chatter chatter_msg;
    const std::string chatter_msg_type = message::MessageType(chatter_msg);
    proto::ChangeMsg change_msg;
    const std::string change_msg_type = message::MessageType(change_msg);
