...
MQTT 插件（`plugins/mqtt/`）面向低带宽、多订阅者场景，与 gRPC 并行运行。**当前实现为空壳**，本文为规划设计与预期行为。

| 本文 §4 | 相关文档 |
|---------|----------|
| Topic、QoS、安全 | [§0 指南](00_guide.md) · [§2 架构](02_architecture.md) · [§6 综述](06_survey.md) |
...
**导航**：[← §3 gRPC](03_grpc.md) · [§6 综述 →](06_survey.md)
