...
从协议体系、架构模式与工程实践综述移动机器人外部桥接，并定位 Autonomy `bridge` 的能力边界与发展路线。

| 本文 §6 | 相关文档 |
|---------|----------|
| 选型、生态对比 | [§0 指南](00_guide.md) · [§2 架构](02_architecture.md) · [§3 gRPC](03_grpc.md) |

---

## 6.1 概述：Bridge 在导航栈中的位置
...
**导航**：[← §4 MQTT](04_mqtt.md) · [§0 指南](00_guide.md)
