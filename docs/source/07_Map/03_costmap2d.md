...
> 模块级架构见 [§1.3](01_architecture.md#13-costmap2d-架构重点)；公式见 [§3.5–§3.8](03_costmap2d.md#35-坐标变换)。
...
| 地形高程/坡度 | ❌ | 用 [GridMap](04_grid_map.md) |
...
- [§3.5–§3.8 坐标与膨胀](03_costmap2d.md#35-坐标变换)
