...
`autonomy/localization` 是 Autonomy 的**定位与 SLAM** 子系统。进程后端：**Cartographer**（默认）、**Lightning**。**AMCL** 配置已预留。本文档为模块总入口。
...
| 算法研发 | [§9 综述](09_survey.md) → [§3 数学原理](03_math.md) → [Cartographer](cartographer/guide.md) |
