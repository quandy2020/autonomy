...
> 模块级架构见 [05_architecture.md §5.4](05_architecture.md#54-gridmap-25d-架构重点)；数学公式见 [§3.5 GridMap 坐标](03_math.md#35-gridmap-坐标变换)。
...
| 路径规划避障 | ❌ 直接用 | 用 [Costmap2D](06_costmap2d.md)；或自行桥接 |
...
### 7.7.2 与 Costmap Rolling Window 对比
...
### 7.8.1 最近邻（INTER_NEAREST）

$$
f(\mathbf{p}) = f(\mathbf{i}_{\text{nearest}})
$$

### 7.8.2 双线性（INTER_LINEAR）
...
### 7.8.3 Keys 双三次卷积（INTER_CUBIC_CONVOLUTION）
