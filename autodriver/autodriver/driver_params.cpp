...
/**
 * @file driver_params.cpp
 * @brief DriverParams string/int/double accessors.
 */
 ...
 * @param[in] text Decimal or 0x-prefixed hex integer text.
 * @param[in] default_value Fallback when parsing fails.
 * @return Parsed int, or @p default_value on failure.
 */
