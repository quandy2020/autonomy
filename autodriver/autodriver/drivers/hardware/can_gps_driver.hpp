...
#ifndef AUTODRIVER_DRIVERS_HARDWARE_CAN_GPS_DRIVER_HPP_
#define AUTODRIVER_DRIVERS_HARDWARE_CAN_GPS_DRIVER_HPP_
...
{
public:
  CanGpsDriver(SensorId sensor_id, DriverParams params);
...
#endif  // AUTODRIVER_DRIVERS_HARDWARE_CAN_GPS_DRIVER_HPP_
