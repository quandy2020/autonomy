 ...
 * CameraInfoChannelForImage follows common ROS-style image → camera_info layout.
 */

#ifndef AUTODRIVER_BRIDGE_CHANNELS_HPP_
#define AUTODRIVER_BRIDGE_CHANNELS_HPP_
...
#endif  // AUTODRIVER_BRIDGE_CHANNELS_HPP_
